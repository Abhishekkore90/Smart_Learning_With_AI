...
const adminModules = [
  ...
  {
    title: "Homework Uploader (गृहपाठ व्यवस्थापक)",
    desc: "Upload and manage class-wise, medium-wise and subject-wise Homework and PDFs for students.",
    icon: BookOpen,
    to: "/admin/homework",
    color: "from-amber-600 to-orange-700",
    glow: "bg-amber-400/20",
    stats: "Homework Files",
    trend: "Live Sync",
    status: "Active",
  },
  {
    title: "Question Paper Uploader (प्रश्नपत्रिका व्यवस्थापक)",
    desc: "Upload and manage Unit Tests, Semester Exams & Practice Question Papers by class, medium and subject.",
    icon: FileText,
