    ...
    <div className="min-h-screen bg-slate-50/50">
      ...
      <main className="lg:pl-64 pt-16 min-h-screen">
        <div className="p-6 md:p-10 max-w-5xl mx-auto space-y-8 flex flex-col justify-center min-h-[calc(100vh-8rem)]">
          ...
          >
            <div className="size-20 bg-blue-50 rounded-[2rem] flex items-center justify-center text-blue-600 mx-auto shadow-sm">
              <FileText className="size-10 animate-pulse" />
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-500 font-medium leading-relaxed">
                विद्यार्थ्यांचे समग्र प्रगती पत्रक (Holistic Progress Card) मूल्यमापन प्रणाली येथे लवकरच उपलब्ध होईल.
              </p>
