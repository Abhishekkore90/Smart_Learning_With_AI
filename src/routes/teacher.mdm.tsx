                                  ...
                                  <tr key={item.key} className={`hover:bg-emerald-50/40 transition-colors ${idx % 2 === 0 ? "bg-white" : "bg-slate-50/50"}`}>
                                    ...
                                    <td className="p-2 border-r border-slate-200 text-center bg-rose-50/30">
                                      <input
                                        ...
                                        className={`w-full h-9 text-center border rounded-lg font-bold text-xs px-2 shadow-2xs outline-none transition-all ${isInvalid
                                    ...
                                    <tbody>
                                      {monthRows.map((r) => {
                                        ...
                                        return (
                                          <tr
                                            key={r.sr}
                                            className={`border-b border-slate-700 text-xs ${isSundayOrHoliday
                                                ? "bg-[#fce8e6]"
                                                : r.sr % 2 === 0
                                                  ? "bg-slate-50/40"
                                                  : "bg-white"
                        ...
                        <div className="bg-[#f8fafc] p-3 md:p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-wrap items-center justify-between gap-4">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className={`px-3 py-1.5 font-extrabold text-xs rounded-xl shadow-sm transition-all cursor-pointer active:scale-95 border ${selectedReportCategory === "tandul_bhag1"
                                  ? "bg-blue-600 text-white border-blue-700"
                                  : "bg-white text-slate-700 border-slate-300 hover:bg-slate-50"
                                }`}
                            >
                            ...
                            <button
                              ...
                              className={`px-3 py-1.5 font-extrabold text-xs rounded-xl shadow-sm transition-all cursor-pointer active:scale-95 border ${selectedReportCategory === "dhanyadi_bhag2"
                                  ? "bg-blue-600 text-white border-blue-700"
                                  : "bg-white text-slate-700 border-slate-300 hover:bg-slate-50"
                                }`}
                            >
                            ...
                            <button
                              ...
                              className={`px-3 py-1.5 font-extrabold text-xs rounded-xl shadow-sm transition-all cursor-pointer active:scale-95 border ${selectedReportCategory === "anudan_report"
                                  ? "bg-blue-600 text-white border-blue-700"
                                  : "bg-white text-slate-700 border-slate-300 hover:bg-slate-50"
                                }`}
                            >
                            ...
                            <button
                              ...
                              className={`px-3 py-1.5 font-extrabold text-xs rounded-xl shadow-sm transition-all cursor-pointer active:scale-95 border ${selectedReportCategory === "purak_ahar_report"
                                  ? "bg-blue-600 text-white border-blue-700"
                                  : "bg-white text-slate-700 border-slate-300 hover:bg-slate-50"
                                }`}
                            >
