...
function TeacherSqaafPage() {
    ...
    const loadCloudData = async () => {
      try {
        ...
        if (snap.exists()) {
          ...
          const yearSavedOpts = localStorage.getItem(`sqaaf_selected_options_${academicYear}`) || localStorage.getItem("sqaaf_selected_options") || localStorage.getItem("sqaaf_selected_options_2025-26");
          if (yearSavedOpts) {
          ...
          const yearSavedStds = localStorage.getItem(`sqaaf_completed_standards_${academicYear}`) || localStorage.getItem("sqaaf_completed_standards") || localStorage.getItem("sqaaf_completed_standards_2025-26");
          if (yearSavedStds) {
          ...
          const yearSavedExt = localStorage.getItem(`sqaaf_external_options_${academicYear}`) || localStorage.getItem("sqaaf_external_options") || localStorage.getItem("sqaaf_external_options_2025-26");
          if (yearSavedExt) {
            try { setExternalOptions(JSON.parse(yearSavedExt)); } catch { setExternalOptions({}); }
          } else {
            setExternalOptions({});
          }
        }
  ...
  const handleAcademicYearChange = (newYear: string) => {
    ...
    if (typeof window !== "undefined") {
      localStorage.setItem("sqaaf_selected_academic_year", newYear);
    }
  ...
  const [certSchoolName, setCertSchoolName] = useState(() => {
    if (typeof window !== "undefined") {
      return localStorage.getItem("sqaaf_cert_school_name") || infoSchoolName || profile?.schoolName || "";
    }
    return "";
  });
  ...
  const [certUdise, setCertUdise] = useState(() => {
    if (typeof window !== "undefined") {
      return localStorage.getItem("sqaaf_cert_udise") || infoUdise || profile?.udise || "";
    }
    return "";
  });
              ...
              <table style="width: 100%; table-layout: fixed; border-collapse: collapse; border: 1px solid black; font-size: 10px; font-family: 'Noto Sans Devanagari', Arial, sans-serif;">
                ...
                <thead>
                  <tr>
                    ...
                    <th rowspan="2" style="border: 1px solid black; padding: 4px;">क्षेत्र</th>
                  ...
                  <tr>
                    <th style="border: 1px solid black; padding: 4px;">स्तर १</th>
                    <th style="border: 1px solid black; padding: 4px;">स्तर २</th>
                    <th style="border: 1px solid black; padding: 4px;">स्तर ३</th>
                    <th style="border: 1px solid black; padding: 4px;">स्तर ४</th>
                    <th style="border: 1px solid black; padding: 4px; background-color: #f1f5f9;">एकूण</th>
                    <th style="border: 1px solid black; padding: 4px;">स्तर १</th>
                    <th style="border: 1px solid black; padding: 4px;">स्तर २</th>
                    <th style="border: 1px solid black; padding: 4px;">स्तर ३</th>
                    <th style="border: 1px solid black; padding: 4px;">स्तर ४</th>
  ...
  const t = {
    mr: {
      ...
      applicableStands: "लागू असलेले मानक",
      notApplicableStands: "लागू नसलेले मानक",
    ...
    en: {
      ...
      applicableStands: "Applicable Standards Count",
      notApplicableStands: "Not Applicable Standards Count",
