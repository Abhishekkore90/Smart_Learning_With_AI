...
<<<<<<< HEAD
    const saved = localStorage.getItem(`sqaaf_evidence_options_config_${standardId}_${selectedOptionIdx}`);
=======
    const saved = localStorage.getItem(
      `sqaaf_evidence_options_config_${standardId}_${selectedOptionIdx}`,
    );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
      const savedOld = localStorage.getItem(
        `sqaaf_evidence_options_config_${standardId}`,
      );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
      if (savedOld) {
        try {
    ...
    getDoc(docRef)
      .then((docSnap) => {
        ...
        if (opts.length === 0 && initialOpts.length === 0) {
          opts = [
            lang === "mr"
              ? "सर्वसाधारण पुरावे / General Evidences"
              : "General Evidences",
          ];
        } else if (opts.length === 0) {
          opts = initialOpts;
...
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
  ...
  const loadUserResponses = (opts: string[]) => {
    ...
    opts.forEach((_, idx) => {
<<<<<<< HEAD
      const checkedSaved = localStorage.getItem(`sqaaf_checked_${standardId}_${selectedOptionIdx}_${idx}`);
      if (checkedSaved !== null) {
        states[idx] = checkedSaved === "true";
      } else if (selectedOptionIdx === 0) {
        const oldChecked = localStorage.getItem(`sqaaf_evidence_checked_${standardId}_${idx}`);
=======
      const checkedSaved = localStorage.getItem(
        `sqaaf_checked_${standardId}_${selectedOptionIdx}_${idx}`,
      );
      if (checkedSaved !== null) {
        states[idx] = checkedSaved === "true";
      } else if (selectedOptionIdx === 0) {
        const oldChecked = localStorage.getItem(
          `sqaaf_evidence_checked_${standardId}_${idx}`,
        );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
<<<<<<< HEAD
      const fileNameSaved = localStorage.getItem(`sqaaf_file_name_${standardId}_${selectedOptionIdx}_${idx}`);
      if (fileNameSaved) {
        names[idx] = fileNameSaved;
      } else if (selectedOptionIdx === 0) {
        const oldName = localStorage.getItem(`sqaaf_evidence_file_name_${standardId}_${idx}`);
      ...
      if (typeSaved) {
        ...
        const oldType = localStorage.getItem(`sqaaf_evidence_file_type_${standardId}_${idx}`);
=======
      const fileNameSaved = localStorage.getItem(
        `sqaaf_file_name_${standardId}_${selectedOptionIdx}_${idx}`,
      );
      if (fileNameSaved) {
        names[idx] = fileNameSaved;
      } else if (selectedOptionIdx === 0) {
        const oldName = localStorage.getItem(
          `sqaaf_evidence_file_name_${standardId}_${idx}`,
        );
        if (oldName) names[idx] = oldName;
      }

      const previewSaved = localStorage.getItem(
        `sqaaf_file_preview_${standardId}_${selectedOptionIdx}_${idx}`,
      );
      if (previewSaved) {
        previews[idx] = previewSaved;
      } else if (selectedOptionIdx === 0) {
        const oldPreview = localStorage.getItem(
          `sqaaf_evidence_file_preview_${standardId}_${idx}`,
        );
        if (oldPreview) previews[idx] = oldPreview;
      }

      const typeSaved = localStorage.getItem(
        `sqaaf_file_type_${standardId}_${selectedOptionIdx}_${idx}`,
      );
      if (typeSaved) {
        types[idx] = typeSaved;
      } else if (selectedOptionIdx === 0) {
        const oldType = localStorage.getItem(
          `sqaaf_evidence_file_type_${standardId}_${idx}`,
        );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    ...
    if (udise) {
      ...
      const responseRef = doc(db, "sqaaf_evidence_responses", docId);
<<<<<<< HEAD
          ...
          if (data) {
            ...
            opts.forEach((_, idx) => {
              if (dbStates[idx] !== undefined) {
                ...
                localStorage.setItem(`sqaaf_checked_${standardId}_${selectedOptionIdx}_${idx}`, dbStates[idx] ? "true" : "false");
              }
              ...
              if (dbTypes[idx] !== undefined) {
                ...
                localStorage.setItem(`sqaaf_file_type_${standardId}_${selectedOptionIdx}_${idx}`, dbTypes[idx]);
              }
            });
...
=======
      await setDoc(
        doc(db, "sqaaf_evidence_responses", docId),
        {
          udise,
          standardId,
          optionIdx: selectedOptionIdx,
...
<<<<<<< HEAD
    localStorage.setItem(`sqaaf_checked_${standardId}_${selectedOptionIdx}_${idx}`, checked ? "true" : "false");
  ...
  const handleMultiFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const currentKeys = Object.keys(fileNames).map(Number);
    let nextIdx = currentKeys.length > 0 ? Math.max(...currentKeys) + 1 : 0;
    ...
    await saveResponseToFirestore(checkedStates, newNames, newPreviews, newTypes);
    toast.success(lang === "mr" ? "सर्व फाईल्स अपलोड झाल्या!" : "All files uploaded!");
=======
    localStorage.setItem(
      `sqaaf_checked_${standardId}_${selectedOptionIdx}_${idx}`,
      checked ? "true" : "false",
  ...
  const handleOptionFileChange = (
    ...
    reader.onloadend = async () => {
      ...
      try {
        ...
        toast.error(
          lang === "mr"
            ? "स्टोरेज फुल आहे, फाईल सेव्ह झाली नाही."
            : "Storage full, file could not be saved locally.",
        );
      }
...
<<<<<<< HEAD
    localStorage.removeItem(`sqaaf_file_name_${standardId}_${selectedOptionIdx}_${idx}`);
    localStorage.removeItem(`sqaaf_file_preview_${standardId}_${selectedOptionIdx}_${idx}`);
    localStorage.removeItem(`sqaaf_file_type_${standardId}_${selectedOptionIdx}_${idx}`);
...
=======
                  ...
                  >
                    {isChecked && (
                      <svg
                        className="size-3.5 fill-none stroke-current stroke-[3.5]"
                        viewBox="0 0 24 24"
                      >
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                  ...
                  >
                    ...
                    {hasFile ? (
                      <div className="flex items-center gap-4 bg-white p-3 rounded-xl border border-pink-200 shadow-sm animate-fade-in text-left">
                        <div
                          onClick={() =>
                            handlePreviewFile(filePreview, fileName, fileType)
                          }
                      ...
                      >
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-slate-400 group-hover:text-pink-700/60 text-[10px] font-medium mt-0.5 transition-colors">
                            {lang === "mr"
                              ? "प्रतिमा (PNG, JPG) किंवा PDF फाईल"
...
<<<<<<< HEAD
      {/* Single Multi-File Upload Section */}
      <div className="pt-6 border-t border-slate-200 mt-6">
        ...
        <div
          onClick={() => {
            const el = document.getElementById(`multi-file-input-${standardId}`);
            if (el) el.click();
          }}
          className="border-2 border-dashed border-slate-300 hover:border-pink-500 rounded-xl p-8 flex flex-col items-center justify-center gap-3 cursor-pointer hover:bg-pink-50/30 transition-all duration-300 group bg-slate-50 shadow-inner"
        >
          <div className="size-12 bg-white text-slate-400 group-hover:bg-pink-100 group-hover:text-pink-600 rounded-full flex items-center justify-center shadow-sm border border-slate-100 group-hover:border-pink-200 transition-all">
            <Upload className="size-6" />
          </div>
          <div className="text-center">
            <p className="text-slate-700 group-hover:text-pink-900 font-bold text-sm tracking-wide">
              {lang === "mr" ? "फाईल्स निवडा किंवा ड्रॅग करा" : "Select files or drag here"}
            </p>
            <p className="text-slate-500 text-xs mt-1">
              {lang === "mr" ? "प्रतिमा (PNG, JPG) किंवा PDF फाईल" : "Image (PNG, JPG) or PDF files"}
            </p>
          </div>
        </div>
        ...
        {Object.keys(fileNames).length > 0 && (
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {Object.keys(fileNames).map((key) => {
              ...
              return (
                <div key={idx} className="flex items-center gap-3 bg-white p-3 rounded-xl border border-slate-200 shadow-sm animate-fade-in text-left">
                  <div
                    onClick={() => handlePreviewFile(filePreview, fileName, fileType)}
                    className="size-12 rounded-lg overflow-hidden bg-slate-50 flex-shrink-0 border border-slate-200 flex items-center justify-center cursor-pointer hover:scale-105 hover:shadow-md transition-all duration-300"
                  >
                    {isPdf(fileType) ? (
                  ...
                  <div className="flex-1 min-w-0">
                    <p
                      onClick={() => handlePreviewFile(filePreview, fileName, fileType)}
                      className="text-slate-800 font-bold text-xs truncate cursor-pointer hover:text-pink-600 hover:underline transition-colors"
                    >
                      {fileName}
                    </p>
                    <p className="text-emerald-600 text-[9px] uppercase tracking-widest font-black mt-1 flex items-center gap-1">
                      <span className="size-1.5 rounded-full bg-emerald-500 inline-block animate-ping" />
                      {lang === "mr" ? "अपलोड केले" : "Uploaded"}
                    </p>
                  </div>
                  <button
                    onClick={() => handleOptionFileClear(idx)}
                    className="p-2 text-slate-450 hover:text-red-500 rounded-lg hover:bg-red-50 border border-transparent hover:border-red-150 transition-all cursor-pointer"
                    title={lang === "mr" ? "काढून टाका" : "Remove"}
                  >
...
=======
        await setDoc(
          doc(db, "sqaf_drive_links", `${udise}_${standardId}`),
          {
            udise,
            standardId,
            links: updated,
...
=======
    toast.success(
      lang === "mr" ? "लिंक यशस्वीरित्या जोडली!" : "Link added successfully!",
    );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
  };
...
=======
            {lang === "mr"
              ? "अद्याप कोणतीही लिंक जोडली नाही"
              : "No links added yet"}
          </p>
          <p className="text-xs text-slate-400">
            {lang === "mr"
              ? "'जोडा' बटण दाबून Google Drive किंवा फोटो लिंक जोडा"
              : "Tap 'Add' to add a Google Drive or photo link"}
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
          </p>
        </div>
      ) : (
...
=======
            <div
              key={idx}
              className="flex items-center gap-3 bg-white border border-slate-100 rounded-2xl p-3.5 shadow-sm hover:shadow-md transition-all group"
            >
              <div
                className="size-10 rounded-xl flex items-center justify-center flex-shrink-0"
                style={{
                  background: isDriveLink(item.url) ? "#e8f5e9" : "#e3f2fd",
                }}
              >
                {isDriveLink(item.url) ? (
...
=======
export const standardsDetailData: Record<
  number,
  {
    mr: {
      orangeDesc: string;
...
> = {
  1: {
    mr: {
      orangeDesc:
        "१.१.१ मुख्याध्यापक आणि शिक्षक अभ्यासक्रमाशी निगडीत दस्तऐवज आणि NCERT, SCERT यांनी प्रकाशित केलेल्या संदर्भ साहित्याशी परिचित आहेत.",
      options: [
        {
          text: "१.१ मुख्याध्यापक आणि शिक्षक यांना NEP- 2020, NCF व SCF च्या मुख्य शिफारशी व अध्ययन निष्पत्ती माहिती आहेत.",
        },
    ...
    en: {
      orangeDesc:
        "1.1.1 Headmaster and teachers are familiar with curriculum-related documents and reference materials published by NCERT, SCERT.",
      options: [
        {
          text: "1.1 Headmaster and teachers know the main recommendations and learning outcomes of NEP-2020, NCF and SCF.",
        },
  ...
  2: {
    mr: {
      orangeDesc:
        "१.१.२ नावीन्यपूर्ण अध्यापनशास्त्रावर आधारित एकात्मिक वार्षिक अभ्यासक्रम आणि अध्यापनशास्त्रीय योजना आहेत.",
      options: [
        {
          text: "१.१ शाळेत एकात्मिक वार्षिक अभ्यासक्रम आणि अध्यापन नियोजन उपलब्ध आहे.",
        },
    ...
    en: {
      orangeDesc:
        "1.1.2 There is an integrated annual curriculum and pedagogical plan based on innovative pedagogy.",
      options: [
        {
          text: "1.1 Integrated annual curriculum and teaching plan is available in school.",
        },
  ...
  3: {
    mr: {
      orangeDesc:
        "१.१.३ शाळा सक्रियपणे आपल्या शिक्षकांसाठी नावीन्यपूर्ण अध्यापनशास्त्र अध्यापनात वापरण्याची क्षमता निर्माण करते तसेच केंद्र परिषदांमध्ये इतर शाळेतील शिक्षकांनीही त्या पद्धती अध्यापनासाठी उपयोगात आणाव्यात असे सुचविते.",
      options: [
        {
          text: "१.१ मुख्याध्यापक व शिक्षकांचे क्षमताधिष्ठीत शिक्षणाचे व नावीन्यपूर्ण अध्यापनाचे प्रशिक्षण झाले आहे.",
        },
    ...
    en: {
      orangeDesc:
        "1.1.3 The school actively builds the capacity of its teachers to use innovative pedagogy in teaching and also suggests to teachers of other schools in the cluster resource center to use those methods for teaching.",
      options: [
        {
          text: "1.1 Headmaster and teachers have received training in competency-based education and innovative teaching.",
        },
  ...
  4: {
    mr: {
      orangeDesc:
        "१.१.४ शाळा माध्यमिक स्तरावरील विद्यार्थ्यांना अभ्यासासाठी विषयांच्या निवडीचे स्वातंत्र्य देते.",
      options: [
        {
          text: "१.१ माध्यमिक शाळेतील विद्यार्थ्यांना अभ्यासासाठी विषयांच्या निवडीचे स्वातंत्र्य आहे.",
        },
    ...
    en: {
      orangeDesc:
        "1.1.4 The school provides secondary level students with the freedom to choose subjects for study.",
      options: [
        {
          text: "1.1 Secondary school students have freedom of choice of subjects for study.",
        },
  ...
  5: {
    mr: {
      orangeDesc:
        "१.२.१ शिक्षकांना विविध विद्यार्थ्यांच्या गरजा लक्षात घेऊन विविध अध्यापन-शिक्षण पद्धती/शिक्षणशास्त्र अवलंबण्यास सक्षम बनवणे.",
      options: [
        {
          text: "१.१ शिक्षकांचे विविध अध्यापन पद्धती विषयी प्रशिक्षण झाले आहे.",
        },
    ...
    en: {
      orangeDesc:
        "1.2.1 Enabling teachers to adopt diverse teaching-learning methods/pedagogy taking into account the needs of different students.",
      options: [
        {
          text: "1.1 Teachers have been trained in various teaching methods.",
        },
  ...
  6: {
    mr: {
      orangeDesc:
        "१.२.२ शाळा सर्व वर्गांसाठी निर्धारित केलेल्या क्षमता आणि अध्ययन निष्पत्तींचा अवलंब करीत आहे.",
      options: [
        {
          text: "१.१ सर्व वर्गांसाठी निर्धारित केलेल्या क्षमता आणि अध्ययन निष्पत्ती वर्गात प्रदर्शित केल्या आहेत.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1rHWFIpAoEkFBCLI5N-xWjFhu5IakCyd",
    },
    en: {
      orangeDesc:
        "1.2.2 The school is adopting the prescribed competencies and learning outcomes for all classes.",
      options: [
        {
          text: "1.1 The prescribed competencies and learning outcomes for all classes are displayed in the classroom.",
        },
  ...
  7: {
    mr: {
      orangeDesc:
        "१.२.३ शाळा अध्ययन अध्यापन अनुभूतीची गुणवत्ता वाढवण्यासाठी तंत्रज्ञानाचा वापर करते.",
      options: [
        {
          text: "१.१ शाळा अध्ययन अध्यापन अनुभूतीची गुणवत्ता वाढवण्यासाठी आठवड्यातून एकदा तंत्रज्ञानाचा वापर करते.",
        },
    ...
    en: {
      orangeDesc:
        "1.2.3 The school uses technology to enhance the quality of the teaching-learning experience.",
      options: [
        {
          text: "1.1 The school uses technology once a week to enhance the quality of the teaching-learning experience.",
        },
  ...
  8: {
    mr: {
      orangeDesc:
        "१.२.४ शाळेत संस्थात्मक सहाध्यायी अध्ययन पद्धतीचा अवलंब केला जातो.",
      options: [
        {
          text: "१.१ प्रशिक्षित शिक्षकांच्या देखरेखीखाली आणि सुरक्षिततेच्या पैलूंची योग्य काळजी घेऊन सहकारी विद्यार्थ्यांसाठी सहाध्यायी अध्ययन हा ऐच्छिक आणि आनंददायक कृती कार्यक्रम घेतला जातो.",
        },
    ...
    en: {
      orangeDesc:
        "1.2.4 Institutional peer learning method is adopted in the school.",
      options: [
        {
          text: "1.1 Under the supervision of trained teachers and taking proper care of safety aspects, peer learning is conducted as an optional and enjoyable activity for fellow students.",
        },
  ...
  9: {
    mr: {
      orangeDesc:
        "१.२.५ शाळेने पर्यावरणपूरक वृत्ती व जीवनशैलीचा अवलंब करणे यावर लक्ष केंद्रित केले आहे.",
      options: [
        {
          text: "१.१ प्रत्येक विद्यार्थ्याला पर्यावरण संवर्धन आणि हवामान बदलाविषयी पुरेशी जागरूकता संपादन करण्यासाठी प्रोत्साहित केले जाते.",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/16yVtKPEe8xi64xREXi4cB48fxFW334",
    },
    en: {
      orangeDesc:
        "1.2.5 The school focuses on adopting eco-friendly attitude and lifestyle.",
      options: [
        {
          text: "1.1 Every student is encouraged to gain adequate awareness about environmental conservation and climate change.",
          isGreen: true,
  ...
  10: {
    mr: {
      orangeDesc:
        "१.३.१ शाळा विद्यार्थ्यांमध्ये रोजगार क्षमता आणि उद्योजकीय कौशल्य विकसित करते.",
      options: [
        {
          text: "१.१ शाळा पूर्व माध्यमिक आणि माध्यमिक स्तरावर व्यावसायिक अभ्यासक्रम राबवण्यासाठी आवश्यक ती पूर्तता करते.",
        },
    ...
    en: {
      orangeDesc:
        "1.3.1 The school develops employability and entrepreneurial skills among students.",
      options: [
        {
          text: "1.1 The school fulfills the necessary requirements for implementing vocational courses at the pre-primary and secondary levels.",
        },
  ...
  11: {
    mr: {
      orangeDesc:
        "१.३.२ शाळा सर्व विद्यार्थ्यांमध्ये स्तरनिहाय डिजिटल, आर्थिक, संप्रेषण, लिंग समभाव आणि आरोग्य साक्षरता याविषयी जाणीव जागृती निर्माण करते.",
      options: [
        {
          text: "१.१ महाराष्ट्र राज्य शिक्षण मंडळाने निर्धारित करून विकसित केलेली डिजिटल, आर्थिक, पर्यावरणीय, माहिती आणि माध्यमे, लिंग आणि आरोग्य साक्षरता नियमावली/मार्गदर्शक तत्त्वे/SOPs, शाळेच्या ग्रंथालयात उपलब्ध आहेत.",
        },
    ...
    en: {
      orangeDesc:
        "1.3.2 The school creates awareness among all students level-wise regarding digital, financial, communication, gender equality and health literacy.",
      options: [
        {
          text: "1.1 Digital, financial, environmental, information and media, gender and health literacy manuals/guidelines/SOPs prescribed and developed by the Maharashtra State Board of Education are available in the school library.",
        },
  ...
  12: {
    mr: {
      orangeDesc:
        "१.३.३ शाळा त्यांच्या इंटर्नशिप योजनेअंतर्गत स्थानिक उद्योगांच्या माध्यमाने इंटर्नशिप, दप्तर विना शाळा व उद्योजकतेच्या संधी प्रदान करते.",
      options: [
        {
          text: "१.१ शालेय कामाचे दहा दिवस हे 'दप्तराविना शाळा' दिवस म्हणून निर्धारित केले जातात व या दिवसांमध्ये शाळेत सर्व प्रकारच्या आनंददायी उपक्रमांचे आयोजन केले जाते.",
        },
    ...
    en: {
      orangeDesc:
        "1.3.3 Under its internship scheme, the school provides opportunities for internships, bagless school, and entrepreneurship through local industries.",
      options: [
        {
          text: "1.1 Ten days of school work are designated as 'Bagless School' days, during which all kinds of enjoyable activities are organized in the school.",
        },
  ...
  13: {
    mr: {
      orangeDesc:
        "१.३.४ शाळा वैचारिक, सामाजिक आणि भावनिक कौशल्यांवर लक्ष केंद्रित करणारा जीवन कौशल्य विकास कार्यक्रम आयोजित करते.",
      options: [
        {
          text: "१.१ शाळेमध्ये वैचारिक, सामाजिक आणि भावनिक कौशल्यांवर लक्ष केंद्रित करणारा इयत्ता आणि वय आधारित जीवन कौशल्य विकास कार्यक्रम राबविला जातो",
        },
    ...
    en: {
      orangeDesc:
        "1.3.4 The school organizes a life skills development program focusing on cognitive, social, and emotional skills.",
      options: [
        {
          text: "1.1 An age-appropriate and grade-appropriate life skills development program focusing on cognitive, social, and emotional skills is implemented in the school.",
        },
  ...
  15: {
    mr: {
      orangeDesc:
        "१.३.६ शाळा स्थानिक 'लोकविद्ये' चा प्रचार करते आणि विद्यार्थ्यांना त्यांच्या व्यावहारिक आणि सैद्धांतिक बाबींबद्दल परिचय करून देते.",
      options: [
        {
          text: "१.१ शाळा स्थानिक लोक-विद्या, व्यापार, उद्योग आणि शेतीविषयक उपक्रमांचे सर्वेक्षण करून माहिती संकलित करते.",
        },
    ...
    en: {
      orangeDesc:
        "1.3.6 The school promotes local 'folk arts/indigenous knowledge' (Lokvidya) and introduces students to their practical and theoretical aspects.",
      options: [
        {
          text: "1.1 The school collects information by conducting surveys of local folk art/indigenous knowledge, business, industry, and agriculture-related activities.",
        },
  ...
  16: {
    mr: {
      orangeDesc:
        "१.३.७ शाळा प्रत्येक विद्यार्थ्याला शिक्षक/स्थानिक कलाकार/पालक/संयुक्त विषय मंडळे किंवा शेजारच्या शाळा/ऑनलाईन क्लासेससह क्लब यांच्या मदतीने कोणत्याही एका कला क्षेत्रात किंवा क्षेत्रांच्या संयोजनात प्रत्येक विद्यार्थ्याला कला शिक्षणासाठी भरपूर संधी उपलब्ध करून देते. (उदा – लोककला, रेखाचित्र आणि चित्रकला, नृत्य, संगीत, साहित्य आणि कविता, थिएटर, ग्राफिक डिझायनिंग, ॲनिमेशन इ.)",
      options: [
        {
          text: "१.१ शाळा वेळापत्रकात कला, संगीत आणि नृत्य नाट्य इ. तासिकांचा समावेश करते.",
        },
  ...
  17: {
    mr: {
      orangeDesc:
        "१.४.१ विद्यार्थ्यांमध्ये आरोग्य, खेळ आणि तंदुरुस्त राहण्याची आजीवन सवय आणि संस्कृती रुजवण्यासाठी शाळेचे धोरण आहे.",
      options: [
        {
          text: "१.१ शाळेमध्ये बैठे खेळ,मैदानी खेळ व योगाभ्यास घेतला जातो. या मध्ये दिव्यांगाना सहभागी केले जाते. शाळेमध्ये दिव्यांगासह प्राथमिक खेळाची सुविधा उपलब्ध आहे.",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/17D2Qzkl-WW69EIksz2PKJLy9DsWKWJVg",
    },
    en: {
      orangeDesc:
        "1.4.1 The school has a policy to instill health, sports, and fitness as a lifelong habit and culture among students.",
      options: [
        {
          text: "1.1 Indoor games, outdoor games, and yoga practices are conducted in the school, involving divyang (specially-abled) students. Primary play facilities are available in the school including for divyang students.",
          isGreen: true,
...
=======
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/17D1pR9XLgPIVX3h5wpuP8NPqCHVNJJtP",
    },
    en: {
      orangeDesc:
        "1.4.2 Annual health check-ups are conducted for all children in the school.",
      options: [
        {
          text: "1.1 Annual health check-ups are conducted for all children in the school.",
          isGreen: true,
  ...
  19: {
    mr: {
      orangeDesc:
        "१.४३ शाळेतील सर्व मुलांची तपासणी (screening) प्रशस्थ ॲपवर (PRASHASHT App) केली जाते (PRASHASHT App अपंगत्व तपासण्यासाठी NCERT ने विकसित केले आहे.)",
      options: [
        {
          text: "१.१ शाळा संबंधित यंत्रणेकडून शिक्षकांना (PRASHASHT) प्रशस्त ॲपचा वापर करण्याबाबतचे व विद्यार्थ्यांच्या प्राथमिक आरोग्य तपासणीचे (screening) प्रशिक्षण आयोजन करते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/17zzQtM6vZIsEpwkHt9ZyaXkdRDF5-szO",
    },
    en: {
      orangeDesc:
        "1.4.3 Screening of all children in the school is conducted on the PRASHASHT App (PRASHASHT App is developed by NCERT for disability screening).",
      options: [
        {
          text: "1.1 The school organizes training for teachers on using the PRASHASHT app and conducting primary health screening for students from the concerned agency.",
        },
  ...
  20: {
    mr: {
      orangeDesc:
        "१.५.१ शाळा काळजी, करूणा आणि आदरार्थी वातावरणात मूल्ये वृद्धिंगत करते. विविधतेचे स्वागत करते आणि सर्व शालेय भागधारकांत सांस्कृतिक मूल्यांची रुजवणूक करते.",
      options: [
        {
          text: "१.१ मूल्यशिक्षणाचा समावेश असलेला अभ्यासक्रम आराखडा SCERT ने तयार केलेला उपलब्ध असून शिक्षक तो वापरतात.\n१.२ अध्ययन अध्यापन प्रक्रियेत मूल्यांचा अंतर्भाव केला जातो.\n१.३ शाळा संबंधित मूल्ये विद्यार्थ्यांमध्ये रुजवण्यासाठी उपक्रमांची आखणी करते",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1823j7cZftCs_5pOgBN_dyrtwaOMgOm_4",
    },
    en: {
      orangeDesc:
        "1.5.1 The school fosters values in a caring, compassionate, and respectful environment. It welcomes diversity and instills cultural values among all school stakeholders.",
      options: [
        {
          text: "1.1 A curriculum framework incorporating value education prepared by SCERT is available and used by teachers.\n1.2 Values are integrated into the teaching-learning process.\n1.3 The school plans activities to instill relevant values in students.",
        },
  ...
  21: {
    mr: {
      orangeDesc:
        "१.५.२ : शाळा वर्गातील आंतरक्रियांमध्ये भारताचा वारसा, सभ्यता, नैतिकता आणि मूल्यांचे ज्ञान समाविष्ट असल्याचे सुनिश्चित करते आणि विद्यार्थ्यांना समाज, प्राणी आणि निसर्गाप्रती कर्तव्यांची जाणीव ठेवण्यास प्रोत्साहित करते.",
      options: [
        {
          text: "१.१ सर्व शिक्षकांना भारतीय संस्कृतीचा वारसा, सभ्यता आणि नैतिकता यांचे पुरेसे ज्ञान आहे.",
        },
    ...
    en: {
      orangeDesc:
        "1.5.2: The school ensures that knowledge of India's heritage, civilization, ethics, and values is included in classroom interactions and encourages students to remain aware of their duties towards society, animals, and nature.",
      options: [
        {
          text: "1.1 All teachers have adequate knowledge of Indian cultural heritage, civilization, and ethics.",
        },
...
3.2 Students identify values and principles that guide their decisions and actions. E.g., various activities are undertaken under "Ek Bharat Shreshtha Bharat".`,
  ...
  22: {
    mr: {
      orangeDesc:
        "१.६.१ विद्यार्थ्यांच्या कामगिरीचे मूल्यांकन करण्यासाठी शिक्षक मूल्यांकनाच्या बहुविध पद्धती वापरतात.",
      options: [
        {
          text: "१.१ शाळेत सर्व विद्यार्थ्यांचे सातत्यपूर्ण आकारिक व संकलित मूल्यमापन केले जाते.",
        },
    ...
    en: {
      orangeDesc:
        "1.6.1 Teachers use multiple methods of assessment to evaluate student performance.",
      options: [
        {
          text: "1.1 Continuous formative and summative assessment of all students is conducted in the school.",
        },
  ...
  23: {
    mr: {
      orangeDesc:
        "१.६.२ सहयोगी आणि स्व-मूल्यांकन तंत्र समजून एकात्मकरण केले आहे.",
      options: [
        {
          text: "१.१ शाळेचे मुख्याध्यापक आणि शिक्षकांना सहयोगी आणि स्वयं-मूल्यांकन तंत्रांबद्दल माहिती आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/18H7GA8LZH_1YGX4bvltJptIIc-ieCo",
    },
    en: {
      orangeDesc:
        "1.6.2 Peer and self-assessment techniques are understood and integrated.",
      options: [
        {
          text: "1.1 The headmaster and teachers of the school are aware of peer and self-assessment techniques.",
        },
  ...
  24: {
    mr: {
      orangeDesc:
        "१.६.३ अध्ययनाचे मूल्यांकन करण्यासाठी क्षमता/ अध्ययन निष्पत्ती या श्रेणी स्तर म्हणून वापरतात. राष्ट्रीय आविष्कार अभियानात विज्ञान आणि गणित शिक्षण आनंददायी व अर्थपूर्ण बनविण्यासाठी कृती एकत्रित केल्या आहेत.",
      options: [
        {
          text: "१.१ शाळेकडे NCERT ने परिभाषित केलेल्या वेगवेगळ्या वर्गासाठीच्या अध्ययन निष्पत्ती आणि क्षमता या संदर्भातील दस्तऐवज उपलब्ध आहेत.\n१.२ राष्ट्रीय आविष्कार अभियानाचा हेतू आणि उद्दिष्टे या बाबत शाळा शिक्षकांसाठी जागृती कार्यक्रम आयोजित करते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/18FLCYLO0Yz7__pPG0NC3aVMqw0wZDu6l",
    },
    en: {
      orangeDesc:
        "1.6.3 Competency/learning outcomes are used as grading levels to evaluate learning. Under Rashtriya Avishkar Abhiyan, activities are integrated to make science and mathematics education enjoyable and meaningful.",
      options: [
        {
          text: "1.1 Documents regarding learning outcomes and competencies defined by NCERT for different classes are available in the school.\n1.2 The school organizes awareness programs for teachers regarding the purpose and objectives of the Rashtriya Avishkar Abhiyan.",
        },
  ...
  25: {
    mr: {
      orangeDesc:
        "१.६.४ प्रत्येक मुलासाठी समग्र प्रगती पत्रक तयार केले आहे. सर्व विद्यार्थी त्यांची प्रगती करून सातत्यपूर्ण विकासाकडे निरंतर वाटचाल करतात.",
      options: [
        {
          text: "१.१ संबंधित विषय शिक्षकांकडून मूल्यांकन केले जाते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/189uOMXYCKgfUOaN3x7rk_a6iiART_iFc",
    },
    en: {
      orangeDesc:
        "1.6.4 A holistic progress card is prepared for every child. All students make progress and move continuously towards sustainable development.",
      options: [
        {
          text: "1.1 Evaluation is done by the concerned subject teachers.",
        },
  ...
  26: {
    mr: {
      orangeDesc:
        "१.६.५ SLAS/PAT/NAS/SEAS च्या जिल्हा अहवालावर आधारित कृती उपक्रम निर्धारित केले आहेत.",
      options: [
        {
          text: "१.१ शिक्षकांनी SLAS/PAT/NAS/SEAS चा जिल्हा अहवाल समजून घेतला आहे.",
        },
    ...
    en: {
      orangeDesc:
        "1.6.5 Action programs are determined based on the district reports of SLAS/PAT/NAS/SEAS.",
      options: [
        {
          text: "1.1 Teachers have understood the district report of SLAS/PAT/NAS/SEAS.",
        },
  ...
  27: {
    mr: {
      orangeDesc:
        "१.६.६ शाळा आपल्या विद्यार्थ्यांची उच्चतम / अधिकाधिक उपस्थिती सुनिश्चित करते.",
      options: [
        {
          text: "१.१ शाळा विद्यार्थ्यांच्या उपस्थितीच्या नोंदी ठेवते.\n१.२ शाळेतील गळती झालेले विद्यार्थी परत आणण्यासाठी धोरणे तयार आहेत.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/19zRNuwiQLmywV-Vx8_mCEIMrO9UUIqAZ",
    },
    en: {
      orangeDesc:
        "1.6.6 The school ensures highest/maximum attendance of its students.",
      options: [
        {
          text: "1.1 The school maintains attendance records of students.\n1.2 Policies are in place to bring back school dropouts.",
        },
  ...
  28: {
    mr: {
      orangeDesc:
        "१.६.७ PAT च्या अहवालावर आधारित कृती उपक्रम निर्धारित केले आहेत.",
      options: [
        {
          text: "१.१ शिक्षकांनी PAT चा अहवाल समजून घेतला आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1A0IVJaf42Qf1bBYXqEYflwscNPRO0C52",
    },
    en: {
      orangeDesc: "1.6.7 Action programs are determined based on PAT reports.",
      options: [
  ...
  29: {
    mr: {
      orangeDesc:
        "१.७.१ शाळेमध्ये पायाभूत तीन ते सहा वयोगटातील मुलांसाठी एक ते तीन वर्षाचे बालवाटिका शिक्षण आहे.",
      options: [
        {
          text: "१.१ शाळांनी पायाभूत अभ्यासक्रम व अध्यापन संरचना सुरू केली आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1A0ZiB6epnp3ZDvWw5Gk5J-66vjWSpH1Z",
    },
    en: {
      orangeDesc:
        "1.7.1 The school offers one to three years of Balvatika education for children in the foundational age group of three to six years.",
      options: [
        {
          text: "1.1 The school has initiated foundational curriculum and pedagogical structure.",
        },
  ...
  30: {
    mr: {
      orangeDesc:
        "१.७.२ वैविध्यपूर्ण अध्ययन अध्यापन साहित्य स्थानिक भाषेत उपलब्ध करून दिले आहे.",
      options: [
        {
          text: "१.१ NCF/SCF वर आधारित प्रादेशिक भाषेत वाचन साक्षरता आणि गणित साक्षरतेसाठी अध्ययन अध्यापन साहित्याची (TLM) उपलब्धता आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1A6KCuKZtaJAuexE0nQy8X3gQli-zoEnR",
    },
    en: {
      orangeDesc:
        "1.7.2 Diverse teaching-learning material (TLM) is made available in the local language.",
      options: [
        {
          text: "1.1 Availability of teaching-learning material (TLM) for reading literacy and mathematical literacy in regional language based on NCF/SCF.",
        },
  ...
  31: {
    mr: {
      orangeDesc:
        "१.७.३ शाळा मातृभाषा/प्रादेशिक भाषा जोपासते आणि शिक्षक भाषेच्या विविधतेद्वारे समवयस्क संबंध बळकट करून त्यांची जोпасना करतात.",
      options: [
        {
          text: "१.१ NCF/SCF मध्ये नमूद केल्याप्रमाणे वाचन साक्षरता आणि गणित साक्षरतेसाठी प्रादेशिक भाषेत अध्ययन अध्यापन साहित्यांची उपलब्धता आहे.\n१.२ शाळा मुलांना त्यांच्या मातृभाषेत लिहिलेली पुस्तके शाळेत आणण्यासाठी वर्गात सामायिक करण्यासाठी प्रोत्साहित करते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1ADUFzMNZAxnOCQI3-XqKj-96wOwlD1g9",
    },
    en: {
      orangeDesc:
        "1.7.3 The school preserves the mother tongue/regional language and teachers foster peer relationships by strengthening linguistic diversity.",
      options: [
        {
          text: "1.1 Availability of teaching-learning materials in the regional language for reading literacy and mathematical literacy as specified in NCF/SCF.\n1.2 The school encourages children to bring books written in their mother tongue to school for sharing in the classroom.",
        },
  ...
  32: {
    mr: {
      orangeDesc:
        "१.७.४ शाळांनी पायाभूत स्तरावरील पाच वर्षासाठी नवोपक्रमशील खेळ आणि खेळणी आधारित कृतीयुक्त अध्यापनचा स्वीकार केला आहे.",
      options: [
        {
          text: "१.१ शाळेत पायाभूत स्तरावर खेळ आणि खेळणी आधारित कृतीयुक्त अध्यापन पद्धतीचा वापर केला जातो.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1AM9SHrgUARde9GGHVvdXCOI301S2fpK",
    },
    en: {
      orangeDesc:
        "1.7.4 Schools have adopted innovative play and toy-based active teaching at the foundational stage for five years.",
      options: [
        {
          text: "1.1 Play and toy-based active teaching methods are used at the foundational stage in the school.",
        },
  ...
  33: {
    mr: {
      orangeDesc:
        "१.७.५ प्रत्येक मुलाची प्रगती सुनिश्चित करण्यासाठी, इयत्ता पहिली व दुसरी मध्ये शाळा निरीक्षण-आधारित मूल्यमापन करते.",
      options: [
        {
          text: "१.१ शाळा इयत्ता पहिली व दुसरीसाठी वयोमानानुसार मूल्यांकन पद्धतींची योजना विकसित करते.",
        },
    ...
    en: {
      orangeDesc:
        "1.7.5 To ensure the progress of every child, the school conducts observation-based assessment in classes I and II.",
      options: [
        {
          text: "1.1 The school develops an age-appropriate assessment methodology plan for classes I and II.",
        },
  ...
  34: {
    mr: {
      orangeDesc:
        "१.७.६ इयत्ता तिसरी पर्यंत पोहोचलेल्या सर्व मुलांनी साक्षरता आणि संख्याज्ञानाची मूलभूत कौशल्ये आत्मसात केली आहेत हे सुनिश्चित करण्यासाठी शाळा FLN कृतींचे बारकाईने निरीक्षण करते.",
      options: [
        {
          text: "१.१ शाळेने निपुण भारत आराखडा स्वीकारले आहे.\n१.२ सर्व शिक्षकांचे FLN/ निष्ठा प्रशिक्षण झाले आहे",
        },
    ...
    en: {
      orangeDesc:
        "1.7.6 The school closely monitors FLN activities to ensure that all children reaching class III have acquired basic literacy and numeracy skills.",
      options: [
        {
          text: "1.1 The school has adopted the NIPUN Bharat framework.\n1.2 All teachers have received FLN/NISHTHA training.",
        },
  ...
  35: {
    mr: {
      orangeDesc:
        "१.७.७ समृद्ध अध्ययन अनुभवासाठी शिक्षक आणि विद्यार्थ्यांच्या आपापसातील भेटींचे आयोजन केले जाते.",
      options: [
        {
          text: "१.१ शाळेकडे शेजारच्या शाळा/शैक्षणिक संस्था आणि अंगणवाड्यांसोबत शिक्षक आणि विद्यार्थ्यांच्या आपापसातील भेटींचे नियोजन केले आहे.",
        },
    ...
    en: {
      orangeDesc:
        "1.7.7 Inter-school visits for teachers and students are organized for an enriched learning experience.",
      options: [
        {
          text: "1.1 The school has planned mutual visits of teachers and students with neighboring schools/educational institutions and Anganwadis.",
        },
  ...
  36: {
    mr: {
      orangeDesc:
        "१.८.१ विद्यार्थ्यांना त्यांच्या करिअर मार्गदर्शन, मानसिक आरोग्य आणि भावनिक आरोग्याशी संबंधित समस्यांचे निराकरणासाठी समुपदेशक उपलब्ध करून दिले जातात.",
      options: [
        {
          text: "१.१ शाळेमध्ये विद्यार्थ्यांना त्यांच्या करिअर मार्गदर्शन, मानसिक आरोग्य आणि भावनिक आरोग्याशी संबंधित समस्यांमध्ये समुपदेशन केले जाते .",
          isGreen: true,
    ...
    en: {
      orangeDesc:
        "1.8.1 Counselors are made available to students to address issues related to their career guidance, mental health, and emotional well-being.",
      options: [
        {
          text: "1.1 Students are provided counseling in the school for issues related to their career guidance, mental health, and emotional well-being.",
          isGreen: true,
  ...
  37: {
    mr: {
      orangeDesc:
        "१.९.१ शिक्षक शालेय शिक्षणामध्ये गुणात्मक सुधारणा घडवून आणण्यासाठी अध्ययन आणि अध्यापन, अध्ययन-अध्यापन साधनांचा विकास (TLM), आणि शिक्षक क्षमता विकसन उपक्रम या क्षेत्रांशी संबंधित नवीन विषय/घटक इत्यादींमध्ये नाविन्यपूर्ण प्रकल्प हाती घेतात.",
      options: [
        {
          text: "१.१ शाळेने गेल्या वर्षभरात अध्ययन अध्यापनाची गुणवत्ता सुधारण्यासाठी एक नाविन्यपूर्ण /अभिनव प्रकल्प हाती घेतला आहे.",
          isGreen: true,
    ...
    en: {
      orangeDesc:
        "1.9.1 Teachers undertake innovative projects related to fields such as learning and teaching, development of teaching-learning materials (TLM), and teacher capacity building initiatives to bring about qualitative improvement in school education.",
      options: [
        {
          text: "1.1 The school has undertaken an innovative/novel project to improve the quality of learning and teaching over the past year.",
          isGreen: true,
  ...
  38: {
    mr: {
      orangeDesc:
        "१.१०.१ शिक्षक विद्यार्थ्यांना चिकित्सक विचार, सर्जनशीलता, समस्या-निराकरण कौशल्ये आणि डिझाइन थिंकिंग स्किल आत्मसात करण्यासाठी मार्गदर्शन करतात, ज्यामुळे त्यांना विविध सामाजिक-आर्थिक आव्हानांना सामोरे जाऊन त्यावर उपाय शोधता येतात.",
      options: [
        {
          text: "१.१ शाळा वरील क्षमतांच्या विकसनासाठी उपक्रमाची आखणी करते.",
        },
    ...
    en: {
      orangeDesc:
        "1.10.1 Teachers guide students to acquire critical thinking, creativity, problem-solving skills, and design thinking skills, enabling them to face various socio-economic challenges and find solutions.",
      options: [
        {
          text: "1.1 The school plans activities for the development of the above competencies.",
        },
  ...
  39: {
    mr: {
      orangeDesc:
        "१.१०.२ माहिती साक्षरता, माध्यम साक्षरता आणि तंत्रज्ञान साक्षरता या एकविसाव्या शतकातील कौशल्यांमध्ये शिकणारे विद्यार्थी निष्णात आहेत.",
      options: [
        {
          text: "१.१ एकविसाव्या शतकातील शिकण्याची कौशल्ये पूर्ण करण्यासाठी शाळा विविध उपक्रमाची आखणी करते.",
        },
    ...
    en: {
      orangeDesc:
        "1.10.2 Learning students are proficient in 21st-century skills such as information literacy, media literacy, and technology literacy.",
      options: [
        {
          text: "1.1 The school plans various activities to fulfill 21st-century learning skills.",
        },
  ...
  40: {
    mr: {
      orangeDesc:
        "१.११.१ शाळा नागरिकत्व कौशल्ये,संविधानातील मूल्ये आणि मूलभूत कर्तव्यांबद्दलच्या जबाबदारीचे ज्ञान आणि समज वाढवते.",
      options: [
        {
          text: "१.१ शाळेच्या ग्रंथालयात विविध मूल्यांवर आधारित पुस्तके, संदर्भ ग्रंथ उपलब्ध आहेत.",
        },
    ...
    en: {
      orangeDesc:
        "1.11.1 The school enhances knowledge and understanding of citizenship skills, constitutional values, and responsibility towards fundamental duties.",
      options: [
        {
          text: "1.1 Books and reference materials based on various values are available in the school library.",
        },
...
=======
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1AzzHAC6yF86DB_wvMa5YniMzQ7",
    },
    en: {
      orangeDesc:
        "1.11.2 The school integrates knowledge of India at all levels.",
      options: [
        {
          text: "1.1 An annual curriculum and teaching plan framework integrating Indian knowledge is available in the school.",
        },
  ...
  42: {
    mr: {
      orangeDesc:
        "१.११.३ शाळा वर्तमान घडामोडींची जागरूकता आणि समज तसेच स्थानिक समुदाय, राज्ये, देश आणि जग सामोरे जात असलेल्या गंभीर समस्यांचे ज्ञान सुनिश्चित करते.",
      options: [
        {
          text: "१.१ शाळा वरील समस्यांच्या निरकरणासाठी उपक्रमाची आखणी करते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1B4foWsK49NCKVQ3aeW7vkbJa-2PzgKT1",
    },
    en: {
      orangeDesc:
        "1.11.3 The school ensures awareness and understanding of current affairs and knowledge of critical issues facing the local community, states, country, and the world.",
      options: [
        {
          text: "1.1 The school plans activities to address the above issues.",
        },
  ...
  43: {
    mr: {
      orangeDesc:
        "१.१२.१ शिक्षक - आशय, संकल्पना, साहित्य, अध्यापन पद्धती इ. बाबत अद्ययावत राहतात.",
      options: [
        {
          text: "१.१ शिक्षक विषयातील आशय, संकल्पना, नाविन्यपूर्ण अध्यापन पद्धती यांचे विविध स्त्रोतातून वाचन करतात व बदल जाणून घेतात.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1BEC9VEznb7zcTuNuLJUrm5V52P1",
    },
    en: {
      orangeDesc:
        "1.12.1 Teachers stay updated regarding content, concepts, materials, pedagogy, etc.",
      options: [
        {
          text: "1.1 Teachers read about subject content, concepts, and innovative pedagogy from various sources and understand changes.",
        },
  ...
  44: {
    mr: {
      orangeDesc:
        "१.१२.२ शिक्षक विविध स्तरावर अभ्यासक्रम, उपक्रम निर्मिती, मोड्यूल निर्मिती, शैक्षणिक साहित्य निर्मिती, प्रशिक्षणात मार्गदर्शक म्हणून योगदान देतात.",
      options: [
        {
          text: "१.१ शिक्षक शाळा स्तरावर मोड्यूल, उपक्रम निर्मिती, शैक्षणिक साहित्य निर्मिती, नाविन्यपूर्ण योजना, प्रशिक्षणात मार्गदर्शक म्हणून योगदान देतात.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1BEOr8fEBiyAs9r3KiD9w5wAM9UgLRI80",
    },
    en: {
      orangeDesc:
        "1.12.2 Teachers contribute as mentors/guides in curriculum development, activity creation, module design, teaching aid preparation, and training at various levels.",
      options: [
        {
          text: "1.1 Teachers contribute as guides in module design, activity creation, teaching aid preparation, innovative schemes, and training at the school level.",
        },
  ...
  45: {
    mr: {
      orangeDesc:
        "२.१.१ शिकण्यास पुरेसा अनुकूल वर्गखोल्या आहेत आणि शाळेने एका सत्रात विद्यमान पायाभूत सुविधांचे बळकटीकरण करण्याचे नियोजन केले आहे.",
      options: [
        {
          text: "१.१ शिक्षक व विद्यार्थी यांच्या प्रमाणात वर्गखोल्या उपलब्ध आहेत .\n१.२ शाळेत (अडथळाविरहीत )प्रवेश करण्यास सुलभ वर्गखोल्या आहेत .",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1BIif3LRYwTja0hAH_CQECKdIsfBI4sE0",
    },
    en: {
      orangeDesc:
        "2.1.1 There are adequate conducive classrooms for learning, and the school has planned to strengthen existing infrastructure within a session.",
      options: [
        {
          text: "1.1 Classrooms are available in proportion to teachers and students.\n1.2 The school has barrier-free accessible entry to classrooms.",
        },
  ...
  46: {
    mr: {
      orangeDesc:
        "२.१.२ शाळेत मुले, मुली, ट्रान्स जेन्डर व CWSN यांच्यासाठी पुरेशा प्रमाणात स्वतंत्र शौचालय उपलब्ध आहेत. स्वच्छतागृहासाठी मुबलक पाणी उपलब्ध असून सर्व स्वच्छतागृहे वापरण्यास योग्य आहेत.",
      options: [
        {
          text: "१.१ शाळेत मुले, मुली, ट्रान्स जेन्डर व CWSN यांच्यासाठी पुरेशा प्रमाणात स्वतंत्र शौचालय उपलब्ध आहेत.\n१.२. Hand Wash स्टेशन अथवा हात धुण्याची सोय विशिष्ठ जागी केली आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1BNbNlPiiEFUalREG0f6ETG1fBEIiXeWm",
    },
    en: {
      orangeDesc:
        "2.1.2 The school has adequate separate toilets for boys, girls, transgender, and CWSN students. Sufficient water is available for the toilets, and all toilets are fit for use.",
      options: [
        {
          text: "1.1 The school has adequate separate toilets for boys, girls, transgender, and CWSN students.\n1.2 Hand wash stations or handwashing facilities are provided at specific locations.",
        },
  ...
  47: {
    mr: {
      orangeDesc:
        "२.१.३ शाळेत ग्रंथालय सुविधा उपलब्ध आहे. नसेल तर समाज सहभाग /इतर संस्थेकडील ग्रंथालय/शेजारील ग्रंथालयांचा वापर करतात.",
      options: [
        {
          text: "१.१ शाळेत स्वतंत्र ग्रंथालय आहे. नसेल तर ग्रंथालय पेट्यांचा वापर केला जातो.\n१.२ ग्रंथालयात विद्यार्थ्यांच्या प्रमाणात पुरेशी पुस्तके उपलब्ध आहेत.",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1BRFLbCAFmMVPugTfijIojtRiMfmTS-PC",
    },
    en: {
      orangeDesc:
        "2.1.3 The school has a library facility. If not, they use community libraries/libraries of other institutions/neighboring libraries.",
      options: [
        {
          text: "1.1 The school has a separate library. If not, library boxes are used.\n1.2 Sufficient books are available in proportion to the number of students.",
          isGreen: true,
  ...
  48: {
    mr: {
      orangeDesc:
        "२.१.४ भाषा/गणित/ विज्ञान इ. विषयासाठी अद्ययावत व सुसज्ज प्रयोगशाळा उपलब्ध आहे",
      options: [
        {
          text: "१.१ भाषा, गणित, विज्ञान प्रयोगशाळा उपलब्ध आहे.\n१.२ भाषापेटी, विज्ञानपेटी, गणितपेटी उपलब्ध आहे.\n१.३ शाळेत भाषा कोपरा, विज्ञान कोपरा, गणित कोपरा आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1BSFEEs7Jc-jvnO_UFbl16jZEXgQIvV4r",
    },
    en: {
      orangeDesc:
        "2.1.4 An updated and well-equipped laboratory is available for languages/mathematics/science etc.",
      options: [
        {
          text: "1.1 Language, mathematics, and science laboratories are available.\n1.2 Language kits, science kits, and mathematics kits are available.\n1.3 There are language, science, and mathematics corners in the school.",
        },
  ...
  49: {
    mr: {
      orangeDesc:
        "२.१.५ शाळा आणि शालेय व्यवस्थापन यांना साह्यभूत होण्यासाठी संगणक व ICT सुविधेचा वापर केला जातो.",
      options: [
        {
          text: "१.१ शिक्षक व विद्यार्थी यांच्या उपयोगासाठी पुरेशा प्रमाणात संगणक व ICT सुविधा उपलब्ध आहे",
        },
    ...
    en: {
      orangeDesc:
        "2.1.5 Computers and ICT facilities are used to support the school and school management.",
      options: [
        {
          text: "1.1 Sufficient computers and ICT facilities are available for the use of teachers and students.",
        },
  ...
  50: {
    mr: {
      orangeDesc:
        "२.१.६ कला, शिल्पकला, नृत्य, नाट्य, विविध मंडळे/क्लब यासाठी शाळेत पुरेशी जागा/ खोल्या आहेत.",
      options: [
        {
          text: "१.१ शाळा वर्गखोलीचा विविध कलागुणांसाठी वापर करते.",
        },
    ...
    en: {
      orangeDesc:
        "2.1.6 The school has adequate space/rooms for art, craft, dance, drama, and various committees/clubs.",
      options: [
        {
          text: "1.1 The school utilizes classrooms for various artistic talents.",
        },
  ...
  51: {
    mr: {
      orangeDesc:
        "२.२.१ शाळेमध्ये आवश्यकतेनुसार प्राचार्य/मुख्याध्यापक, कर्मचारी आणि प्रशासनासाठी पुरेशी जागा आहे.",
      options: [
        {
          text: "१.१ शाळेमध्ये मुख्याध्यापक कार्यालय आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1BdIKu70bm8qNmu65zrDEFH_Yq1",
    },
    en: {
      orangeDesc:
        "2.2.1 There is adequate space in the school for the principal/headmaster, staff, and administration as required.",
      options: [
        {
          text: "1.1 A headmaster's office is available in the school.",
        },
  ...
  52: {
    mr: {
      orangeDesc:
        "२.३.१ विद्यार्थ्यांच्या शारीरिक व मानसिक आरोग्यासंबंधी शाळेला जाणीव असून आरोग्य सेवा आणि व्यवस्थापन सुविधा उपलब्ध आहेत.",
      options: [
        {
          text: "१.१ प्रथमोपचार पेटी आहे.\n१.२ आपत्कालीन परिस्थितीत आवश्यक औषधपुरवठा केला आहे.\n१.३ दर्शनी भागात आपत्कालीन वैद्यकीय सहाय्यता क्रमांक प्रकाशित केले आहेत.\n१.४ शाळेने दर्शनी भागात तंबाखू मुक्त परिसर असा फलक लावला आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1BfdrAOMZjkqLmBFyuG_TSKy4BGQtmXdy",
    },
    en: {
      orangeDesc:
        "2.3.1 The school is aware of the physical and mental health of students and health services and management facilities are available.",
      options: [
        {
          text: "1.1 First aid box is available.\n1.2 Necessary medicine supply is provided in emergency situations.\n1.3 Emergency medical assistance numbers are displayed in the visible area.\n1.4 The school has displayed a tobacco-free zone board in the visible area.",
        },
  ...
  53: {
    mr: {
      orangeDesc:
        "२.४.१ शाळा स्वच्छता आणि स्वच्छतेविषयी जाणीव जागृतीस चालना देते.",
      options: [
        {
          text: "१.१ शालेय परिसर स्वच्छ ठेवला आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1AEXMZSW5Qrbpwis74zoRg6FQn",
    },
    en: {
      orangeDesc:
        "2.4.1 The school promotes cleanliness and awareness about hygiene/cleanliness.",
      options: [
        {
          text: "1.1 School premises are kept clean.",
        },
  ...
  54: {
    mr: {
      orangeDesc:
        "२.४.२ शाळेत पिण्याचे सुरक्षित पाणी आणि पुरेसा स्वच्छतेच्या सुविधा उपलब्ध आहेत.",
      options: [
        {
          text: "१.१ शाळामध्ये पिण्यायोग्य पाण्याची सुविधा आहे.",
        },
    ...
    en: {
      orangeDesc:
        "2.4.2 Safe drinking water and adequate sanitation facilities are available in the school.",
      options: [
        {
          text: "1.1 Drinking water facility is available in the school.",
        },
  ...
  55: {
    mr: {
      orangeDesc:
        "२.५.१ शाळेमध्ये पुरेसे सुरक्षित, आरामदायक वयोमानानुसार आणि आकर्षक रचना केलेले फर्निचर आहे.",
      options: [
        {
          text: "१.१ विद्यार्थी आणि शिक्षक संख्येनुसार पुरेसे फर्निचर उपलब्ध आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1C3Z8qJLmslU5GZeytuoPF5RrogZM",
    },
    en: {
      orangeDesc:
        "2.5.1 The school has adequate, safe, comfortable, age-appropriate, and attractively designed furniture.",
      options: [
        {
          text: "1.1 Sufficient furniture is available according to the number of students and teachers.",
        },
...
=======
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1CAMACWoI0lwxdChrkkzJt2cDYoFZC1rG",
    },
    en: {
      orangeDesc: "2.6.1 The school has lighting and ventilation systems.",
      options: [
...
=======
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1CIED9oU9acnZc4swkMmLg-U-1Ch4744s",
    },
    en: {
      orangeDesc:
        "2.6.2 Fire safety measures have been implemented in the school.",
      options: [
        {
          text: "1.1 Fire extinguishers are available.",
        },
  ...
  58: {
    mr: {
      orangeDesc:
        "२.६.३ आपत्ती व्यवस्थापनासाठी प्रभावी उपाययोजना केल्या आहेत. शाळेची स्वतःची आपत्तीकालीन सज्जता योजना आहे व प्रत्येक वर्गात ठळकपणे प्रदर्शित केली आहे.",
      options: [
        {
          text: "१.१ आपत्ती व्यवस्थापनासाठी शाळेने योजना विकसित केली आहे",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1CTdXeHpbXep6BK3hbQwFI9peXWh_Dk91",
    },
    en: {
      orangeDesc:
        "2.6.3 Effective measures have been taken for disaster management. The school has its own disaster preparedness plan, which is prominently displayed in every classroom.",
      options: [
        {
          text: "1.1 The school has developed a plan for disaster management.",
          isGreen: true,
  ...
  59: {
    mr: {
      orangeDesc:
        "२.७.१ शाळा पर्यावरणपूरक पद्धतीचे पालन करते. शिक्षक, विद्यार्थी, पालक, समाज, पर्यावरणाचे संवर्धन करण्यासाठी कार्यशाळा /उपक्रम आयोजित करते. शाळा हवामान बदल, सेंद्रिय जीवनशैलीचा समावेश करण्यासाठी एकत्र येऊन जागरूकता निर्माण करते.",
      options: [
        {
          text: "१.१ शालेय परिसरात हिरवीगार झाडे/हिरवळ उपलब्ध आहे.\n१.२ शाळेकडून ओला कचरा व सुका कचरा यांचे वर्गीकरण केले जाते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1CZCI1Mve0G9CYqbjOQL7FDyTRPhNI93R",
    },
    en: {
      orangeDesc:
        "2.7.1 The school follows eco-friendly practices. It organizes workshops/activities to conserve the environment involving teachers, students, parents, and community. The school comes together with the community to raise awareness for addressing climate change and adopting an organic lifestyle.",
      options: [
        {
          text: "1.1 Green trees/lawns are available in the school premises.\n1.2 Wet and dry waste are segregated by the school.",
        },
  ...
  60: {
    mr: {
      orangeDesc:
        "२.७.२ शाळा ऊर्जा बचतीसाठी LED प्रकाश/सौरऊर्जेचा वापर, टाकाऊ वस्तूचे व्यवस्थापन/पुनर्वापर, जल पुनर्भरण व प्लास्टिक मुक्तीसाठी विविध उपक्रमांचे आयोजन करते.",
      options: [
        {
          text: "१.१ शाळा ऊर्जाबचतीसाठी कमी विद्युतवर चालणारी उपकरणे वापरते. उदा. LED बल्ब ,एनर्जी सेवर उपकरणे, ५ स्टार उपकरणे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1CbRQoYaSq-OEMFjD5zYGsjBSwQwf95y",
    },
    en: {
      orangeDesc:
        "2.7.2 The school organizes various initiatives for energy conservation (using LED lighting/solar energy), waste management/reuse, water recharging, and plastic-free campaigns.",
      options: [
        {
          text: "1.1 The school uses low-electricity-consuming equipment for energy savings, e.g., LED bulbs, energy saver appliances, 5-star rated equipment.",
        },
  ...
  61: {
    mr: {
      orangeDesc:
        "२.७.३ शाळेकडे प्रधानमंत्री पोषण शक्ती निर्माण योजनेसाठी स्वतंत्र स्वयंपाकगृह असून परसबाग/ किचन गार्डन मधील सेंद्रिय/ नैसर्गिक पद्धतीने पिकवलेला भाजीपाल्याचा वापर करतात.",
      options: [
        {
          text: "१.१ शाळेत स्वयंपाकगृह आहे.\n१.२ स्वयंपाकगृहात आहार शिजवण्यासाठी व वितरणासाठी पुरेशी भांडी आहेत.\n१.३ शाळेकडे परसबाग/ किचन गार्डनचे नियोजन केले आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1CcuXXmzg-OEMFjD5zYGsjBSwQwf95y",
    },
    en: {
      orangeDesc:
        "2.7.3 The school has a separate kitchen for the Pradhan Mantri Poshan Shakti Nirman Yojana and uses organic/natural vegetables grown in the kitchen garden.",
      options: [
        {
          text: "1.1 The school has a kitchen.\n1.2 The kitchen has adequate utensils for cooking and distribution of food.\n1.3 The school has planned for a kitchen garden.",
        },
  ...
  62: {
    mr: {
      orangeDesc:
        "२.८.१ विद्यार्थ्यांमध्ये इनडोअर आणि आऊटडोअर खेळ, योग, व्यायामविषयक जाणीव असून यासाठीची आवश्यक उपकरणे शाळेत उपलब्ध आहेत. दिव्यांगासाठी स्वतंत्र सोय आहे.",
      options: [
        {
          text: "१.१ शाळेकडे स्वतःचे क्रीडांगण उपलब्ध आहे. नसल्यास पर्यायी व्यवस्था आहे.\n१.२ क्रीडाखोली उपलब्ध असून आवश्यकतेनुसार क्रीडासाहित्य उपलब्ध करून दिले जाते, नोंदी ठेवल्या जातात.\n१.३ शाळेने विविध क्रीडा प्रकारात सहभाग घेतला आहे.",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1Ck13rhMrbhfWo3UrPh-gyBvWTxHfuiVJ",
    },
    en: {
      orangeDesc:
        "2.8.1 Students have awareness about indoor and outdoor sports, yoga, and exercise, and the necessary equipment for this is available in the school. There is separate provision for CWSN students.",
      options: [
        {
          text: "1.1 The school has its own playground. If not, alternative arrangement is available.\n1.2 Sports room is available and sports equipment is provided as per need, records are maintained.\n1.3 The school has participated in various sports.",
          isGreen: true,
  ...
  63: {
    mr: {
      orangeDesc:
        "२.९.१ निवासी शाळेत पुरेषा खोल्या/वसतिगृहे, मनोरंजनाची जागा, शौचालये, पिण्याचे पाणी ठिकाण, वार्डन, कर्मचारी निवासस्थान, अभ्यांगत खोली, कपडे धुण्याची खोली, धान्यकोठी, कॉमन रूम, अतिरिक्त खोली उपलब्ध आहे.",
      options: [
        {
          text: "१.१ पायाभूत व बोर्डिंग सुविधा उपलब्ध आहे.\n१.२ मुले वा मुलींसाठी वेगवेगळ्या इमारती आहेत.\n१.३ शयनगृहे उपलब्ध आहेत.\n१.४ पिण्यासाठी, स्वयंपाकासाठी आणि स्वच्छतागृहांसाठी पुरेसे पाणी उपलब्ध आहे.\n१.५ वायुवीजन व पुरेशी प्रकाशव्यवस्था उपलब्ध आहे.\n१.६. वॉर्डन उपलब्ध असून त्यांचे संपूर्ण वसतिगृहावर लक्ष आहे.",
        },
    ...
    en: {
      orangeDesc:
        "2.9.1 Residential schools have adequate rooms/hostels, recreation areas, toilets, drinking water facilities, warden, staff quarters, visitor rooms, laundry rooms, grain stores, common rooms, and additional rooms available.",
      options: [
        {
          text: "1.1 Foundational and boarding facilities are available.\n1.2 Separate buildings are available for boys and girls.\n1.3 Dormitories are available.\n1.4 Adequate water is available for drinking, cooking, and toilets.\n1.5 Ventilation and adequate lighting are available.\n1.6 Warden is available and oversees the entire hostel.",
        },
  ...
  65: {
    mr: {
      orangeDesc:
        "२.९.३ शाळा निवासी सुविधांमध्ये विद्यार्थ्यांची सुरक्षितता आणि सुरक्षा निश्चित करते.",
      options: [
        {
          text: "१.१ शालेय परिसरात सर्व बाजूंनी संरक्षण भिंत आहे.\n१.२ प्रवेशद्वारावर २४ तास सुरक्षा रक्षक आहे.\n१.३ अधिकृत व्यक्तीशिवाय प्रवेश दिला जात नाही.\n१.४ शाळेत अग्निशामक यंत्र व प्रथमोपचार पेटी उपलब्ध आहे.\n१.५ शाळेत पूर्णवेळ डॉक्टर व परिचारिका उपलब्ध आहे अथवा जवळच्या रुग्णालयाशी करार केला आहे.\n१.६ आपत्कालीन वैद्यकीय सेवा क्रमांक दर्शनी भागात लावले आहे.\n१.७ आपत्कालीन परिस्थितीमध्ये बाहेर पडण्याचा नकाशा दर्शनी भागात प्रदर्शित केला आहे.\n१.८ बाल सुरक्षा समिती स्थापन केली आहे.",
        },
    ...
    en: {
      orangeDesc:
        "2.9.3 The school ensures the safety and security of students in residential facilities.",
      options: [
        {
          text: "1.1 There is a boundary wall surrounding the school premises on all sides.\n1.2 There is a 24-hour security guard at the entrance.\n1.3 Entry is not permitted without authorized personnel.\n1.4 Fire extinguishers and first aid boxes are available in the school.\n1.5 Full-time doctor and nurse are available in the school or agreement is made with a nearby hospital.\n1.6 Emergency medical service numbers are displayed in the visible area.\n1.7 An evacuation map for emergency situations is displayed in the visible area.\n1.8 Child safety committee has been established.",
        },
  ...
  66: {
    mr: {
      orangeDesc:
        "२.९.४ शाळा विद्यार्थ्यांच्या शारीरिक, मानसिक, सामाजिक, भावनिक व बौद्धिक विकासासाठी विविध उपक्रमाचे आयोजन करते.",
      options: [
        {
          text: "१.१ विद्यार्थ्यांची वेळोवेळी आरोग्य तपासणी केली जाते.\n१.२ वसतिगृहात दिनचर्या / वेळापत्रक आहे.\n१.३ शारीरिक व्यायाम व खेळ यांचे वेळापत्रक करून लावले आहे.\n१.४ शैक्षणिक दिनचर्या वेळापत्रकानुसार आयोजित केली आहे.",
        },
    ...
    en: {
      orangeDesc:
        "2.9.4 The school organizes various activities for students' physical, mental, social, emotional, and intellectual development.",
      options: [
        {
          text: "1.1 Regular health check-ups of students are conducted.\n1.2 There is a daily routine / timetable in the hostel.\n1.3 Timetable for physical exercise and sports is put up.\n1.4 Educational routine is organized according to the timetable.",
        },
  ...
  67: {
    mr: {
      orangeDesc:
        "२.१०.१ शाळेत स्वच्छ, आरोग्यदायी व सुरक्षिततेच्या निकषाचे पालन करणारे उपहारगृह/स्वयंपाकगृह आहे.",
      options: [
        {
          text: "१.१ शाळेत उपहारगृह/स्वयंपाकगृह उपलब्ध आहे.\n१.२ उपहारगृह /स्वयंपाकगृहामध्ये साठवलेले पदार्थ स्वच्छतेचे निकष पाळून ठेवले आहेत.\n१.३ उपहारगृहात/स्वयंपाकगृहात दर्शनी भागात दरफलक लावला आहे.\n१.४ सुरक्षा व स्वच्छतेच्या सर्व मानकाचे पालन केले आहे.",
          isGreen: true,
    ...
    en: {
      orangeDesc:
        "2.10.1 The school has a clean, healthy, and safe canteen/kitchen adhering to safety and hygiene norms.",
      options: [
        {
          text: "1.1 Canteen/kitchen is available in the school.\n1.2 Items stored in the canteen/kitchen are kept adhering to cleanliness norms.\n1.3 Price list is displayed in the visible area of the canteen/kitchen.\n1.4 All safety and cleanliness standards are followed.",
          isGreen: true,
  ...
  68: {
    mr: {
      orangeDesc:
        "२.११.१ शाळेत ICT/स्मार्ट क्लास सुविधा उपलब्ध असून अभ्यासक्रम लोड केलेले टॅब/डिजिटल लायब्ररी आहे.",
      options: [
        {
          text: "१.१ शाळेमध्ये शैक्षणिक उपक्रमांना समर्थन देण्यासाठी आयसीटी लॅब/स्मार्ट क्लास सुविधा आहे.",
          isGreen: true,
    ...
    en: {
      orangeDesc:
        "2.11.1 The school has ICT/smart class facilities available and has curriculum-loaded tablets/digital library.",
      options: [
        {
          text: "1.1 The school has ICT lab/smart class facility to support educational activities.",
          isGreen: true,
  ...
  69: {
    mr: {
      orangeDesc:
        "२.११.२ शाळेकडे अविरत चालणारे आंतरजाल (इंटरनेट) सुविधा उपलब्ध आहे",
      options: [
        {
          text: "१.१ शाळेमध्ये अखंड इंटरनेट कनेक्शनची सुविधा उपलब्ध आहे. (मोबाईल/डोंगल)",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1DFjjpRBFJ-QaoRRbii3uiDr6NDRBPAYB",
    },
    en: {
      orangeDesc:
        "2.11.2 The school has continuous internet facility available.",
      options: [
        {
          text: "1.1 Uninterrupted internet connection facility is available in the school (mobile/dongle).",
        },
  ...
  70: {
    mr: {
      orangeDesc:
        "२.१२.१ शाळेने शिक्षकाकडून सर्वेक्षण करून दाखलपात्र सर्व विद्यार्थ्यांचे विशेषतः सामाजिक, आर्थिक, वंचित घटकातील विद्यार्थ्यांची पटनोंदणी केली आहे.",
      options: [
        {
          text: "१.१ शिक्षक पटनोंदणीसाठी सर्व्हेक्षण करतात.",
        },
    ...
    en: {
      orangeDesc:
        "2.12.1 The school has enrolled all eligible students, especially from social, economic, and disadvantaged sections, through a survey conducted by teachers.",
      options: [
        {
          text: "1.1 Teachers conduct surveys for enrollment.",
        },
  ...
  71: {
    mr: {
      orangeDesc:
        "२.१२.२ शाळा सर्व इयत्तांमध्ये शून्य गळतीदर आणि १०० % संक्रमण दर राखते.",
      options: [
        {
          text: "१.१ अध्ययनपूरक वातावरण निर्मिती करून शाळा सर्व विद्यार्थ्यांना प्रवेश व पायाभूत सुविधा पुरवते त्यासाठी प्रशिक्षित शिक्षक उपलब्ध आहेत.\n१.२ शाळा इमारत व वर्ग खोल्या आकर्षक आहेत.",
        },
    ...
    en: {
      orangeDesc:
        "2.12.2 The school maintains zero dropout rate and 100% transition rate in all classes.",
      options: [
        {
          text: "1.1 The school provides admission and basic facilities to all students by creating a learning-conducive environment, and trained teachers are available for it.\n1.2 The school building and classrooms are attractive.",
        },
  ...
  72: {
    mr: {
      orangeDesc:
        "२.१२.३ शाळा सर्व शिक्षण स्तरातील सर्व विद्यार्थ्यांना शाळेत किंवा जवळच्या शाळेत प्रवेशाची संधी उपलब्ध करून देते.",
      options: [
        {
          text: "१.१ शाळा सर्व मुलांना शाळेत प्रवेश देते.",
        },
    ...
    en: {
      orangeDesc:
        "2.12.3 The school provides opportunities for admission to all students across all levels of education in the school or a nearby school.",
      options: [
        {
          text: "1.1 The school provides admission to all children.",
        },
  ...
  73: {
    mr: {
      orangeDesc:
        "२.१२.४ माध्यमिक शिक्षण पूर्ण करून पुढील शिक्षण घेणाऱ्या विद्यार्थ्यांची संख्या दरवर्षी वाढते.",
      options: [
        {
          text: "१.१ उच्च शिक्षणाबाबत शाळा विद्यार्थ्यांमध्ये जागृती निर्माण करते.\n१.२ शालेय- सहशालेय संमेलने, विविध कार्यक्रम यामधून विद्यार्थ्यांमध्ये उच्च शिक्षणाबाबत ध्येय निर्मिती करते.\n१.३ विद्यार्थ्यांमध्ये आवड निर्मितीसाठी अभियोग्यता कल-चाचणी शिक्षक किंवा शाळेमार्फत आयोजित केली जाते.\n१.४ शाळेच्या दर्शनी भागात करिअर मार्गदर्शन तक्ता, चित्रे, लोगो काढले आहेत.",
        },
    ...
    en: {
      orangeDesc:
        "2.12.4 The number of students pursuing higher education after completing secondary education increases every year.",
      options: [
        {
          text: "1.1 The school creates awareness among students about higher education.\n1.2 Through school and co-curricular conferences and programs, the school sets goals for higher education among students.\n1.3 To generate interest among students, aptitude/interest tests are organized by teachers or the school.\n1.4 Career guidance charts, pictures, and logos are displayed in the visible area of the school.",
        },
  ...
  74: {
    mr: {
      orangeDesc:
        "२.१२.५ शाळेने माजी विद्यार्थी संघाची स्थापना करून त्यांचा शालेय विकासात उपयोग करून घेतला आहे.",
      options: [
        {
          text: "१.१ शाळेने सर्व माजी विद्यार्थ्यांच्या नोंदी घेतल्या आहेत.",
          isGreen: true,
    ...
    en: {
      orangeDesc:
        "2.12.5 The school has established an alumni association and utilized them in school development.",
      options: [
        {
          text: "1.1 The school has recorded details of all alumni.",
          isGreen: true,
  ...
  75: {
    mr: {
      orangeDesc:
        "३.१.१ शाळेत पात्र आणि सक्षम कर्मचारी शाळेच्या ध्येय आणि उद्दिष्ट पूर्तीसाठी शाळेत शासनाने निर्देशित केलेल्या निकषानुसार पुरेसे पात्र आणि सक्षम कर्मचारी आहेत.",
      options: [
        {
          text: "१.१ शाळेत पुरेसे शिक्षक व शिक्षकेत्तर कर्मचारी नियुक्त केले आहेत.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1DU-57DGZJkkKpzCYB-jBShWGboMA0Djt",
    },
    en: {
      orangeDesc:
        "3.1.1 There are adequate qualified and competent staff in the school as per the criteria directed by the government for achieving the goals and objectives of the school.",
      options: [
        {
          text: "1.1 Adequate teaching and non-teaching staff are appointed in the school.",
        },
  ...
  76: {
    mr: {
      orangeDesc:
        "३.१.२ शाळेमधील नवनियुक्त कर्मचारी / कर्मचारी यांचा राज्य / जिल्हा / तालुका / केंद्र स्तरावरील उदबोधन कार्यक्रमामध्ये सहभाग घेतात.",
      options: [
        {
          text: "१.१ कर्मचारी हे त्यांची कामे स्वतः , वरिष्ठ सहकारी यांच्या मार्गदर्शनात आत्मसात करतात.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1DVHSui6gR8Kezh3KxD77cPj-kg-fidLs",
    },
    en: {
      orangeDesc:
        "3.1.2 Newly appointed staff / staff in the school participate in orientation programs at the state / district / block / cluster level.",
      options: [
        {
          text: "1.1 Employees acquire their work on their own, under the guidance of senior colleagues.",
        },
  ...
  77: {
    mr: {
      orangeDesc:
        "३.१.३ शाळा / केंद्र / तालुका स्तरावर कर्मचाऱ्यांचे मूल्यांकन केले जाते.",
      options: [
        {
          text: "१.१ मुख्याध्यापक लॉगबुक मध्ये वर्ग निरीक्षणाच्या नोंदी करतात.\n१.२ मुख्याध्यापक शिक्षक मूल्यांकनाचे पूर्वनिर्धारित निकष शिक्षकांच्या निदर्शनास आणून देतात.",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1D_DOQrqYLkg4epHH2ItvGu7EN9vVlvVy",
    },
    en: {
      orangeDesc:
        "3.1.3 Staff evaluation is conducted at school / cluster / block level.",
      options: [
        {
          text: "1.1 Headmaster records classroom observations in the logbook.\n1.2 Headmaster brings the pre-determined criteria of teacher evaluation to the notice of teachers.",
          isGreen: true,
  ...
  78: {
    mr: {
      orangeDesc:
        "३.१.४ शाळा CRC / BRC / DIET / प्रादेशिक कार्यालयाशी सल्लामसलत करून, कर्मचारी विकास कार्यक्रम आणि शिक्षकांची क्षमता वाढवते.",
      options: [
        {
          text: "१.१ शिक्षक शैक्षणिक विचारांचे आदानप्रदान करण्यासाठी शिक्षण परिषदेत सहभागी होतात.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1DhmML4sGbNaz7YY0YBQgYVHWODsr25az",
    },
    en: {
      orangeDesc:
        "3.1.4 The school consults with CRC / BRC / DIET / regional office to enhance staff development programs and teachers' capacities.",
      options: [
        {
          text: "1.1 Teachers participate in educational conferences to exchange educational ideas.",
        },
  ...
  79: {
    mr: {
      orangeDesc:
        "३.१.५ शाळा त्यांच्या नाविन्यपूर्ण / प्रभावी योगदानासाठी कर्मचाऱ्यांच्या कामाची ओळख आणि प्रशंसा प्रदान करते.",
      options: [
        {
          text: "१.१ परिपाठ व शाळा स्तरावरील सभांमध्ये कर्मचाऱ्यांचा सन्मान केला जातो.",
        },
    ...
    en: {
      orangeDesc:
        "3.1.5 The school provides recognition and praise for employees' work for their innovative / effective contributions.",
      options: [
        {
          text: "1.1 Employees are honored in assemblies and school-level meetings.",
        },
  ...
  80: {
    mr: {
      orangeDesc:
        "३.१.६ शाळेमध्ये कर्मचाऱ्यांच्या सदुपदेशनासाठी चांगली विकसित यंत्रणा आहे. (Online / Offline)",
      options: [
        {
          text: "१.१ शिक्षक, मुख्याध्यापक/ शाळा प्रमुख यांच्याशी शाळेतील आव्हानात्मक बाबींसंबंधी चर्चा करतात.",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1DvtRkmbSdzXQO66lJIZilAGlqzyGN2TD",
    },
    en: {
      orangeDesc:
        "3.1.6 The school has a well-developed mechanism for mentoring of employees. (Online / Offline)",
      options: [
        {
          text: "1.1 Teachers discuss challenging school matters with headmaster/school head.",
          isGreen: true,
  ...
  81: {
    mr: {
      orangeDesc:
        "३.२.१ मुख्याध्यापक यांचेकडे शाळेला प्रगतीकडे नेण्याकरिता स्पष्ट दृष्टी आणि दिशा आहे.",
      options: [
        {
          text: "१.१ मुख्याध्यापक आपले निर्णय शालेय सहकाऱ्यांशी सामायिक करतात.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1E7ZZJ87m7d5nWm-8U0c3ybpy6VHLcKoY",
    },
    en: {
      orangeDesc:
        "3.2.1 The headmaster has a clear vision and direction to lead the school towards progress.",
      options: [
        {
          text: "1.1 The headmaster shares decisions with school colleagues.",
        },
  ...
  82: {
    mr: {
      orangeDesc:
        "३.३.१ मुख्याध्यापक शाळा विकास घडवून आणण्यासाठी भागधारकांशी प्रभावी संप्रेषणाद्वारे सहयोग आणि सुसंबंध प्रस्थापित करतात.",
      options: [
        {
          text: "१.१ मुख्याध्यापक सहकार्यांमध्ये होणाऱ्या संप्रेषणाची खात्री करतात.\n१.२ विद्यालय केंद्र स्तरावरील इतर शाळेशी सक्रीय शैक्षणिक आंतरक्रिया घडवून आणतात.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1EDo-fj9wtXJ8OAXZCFTjF7dzjsJ9SNFD",
    },
    en: {
      orangeDesc:
        "3.3.1 The headmaster establishes cooperation and good relations through effective communication with stakeholders to bring about school development.",
      options: [
        {
          text: "1.1 The headmaster ensures communication among colleagues.\n1.2 Active academic interactions are conducted with other schools at the cluster resource center level.",
        },
  ...
  83: {
    mr: {
      orangeDesc:
        "३.४.१ शाळा व्यवस्थापन,मुख्याध्यापक आणि सर्व कर्मचारी मिळून चालू असलेल्या बदलांचे मार्गदर्शन करणारी परिवर्तनात्मक भूमिका विकसित करतात आणि नियमितपणे पुनर्विलोकन करतात.",
      options: [
        {
          text: "१.१ शाळा होऊ घातलेले बदल आणि गुणवत्ता व्यवस्थापनासाठी प्रणाली स्वीकार करते.",
        },
    ...
    en: {
      orangeDesc:
        "3.4.1 The school management, headmaster, and all staff together develop a transformative role guiding ongoing changes and regularly conduct reviews.",
      options: [
        {
          text: "1.1 The school adopts systems for impending changes and quality management.",
        },
  ...
  84: {
    mr: {
      orangeDesc:
        "३.५.१. SCERT / DIET अशा व्यावसायिक विकास संस्थांच्या सहाय्याने शिक्षक, क्षमता बांधणी व व्यावसायिक विकासाच्या प्रक्रियेत सहभागी होतात.",
      options: [
        {
          text: "१.१ SCERT / DIET अशा व्यावसायिक विकास संस्थांच्या सहाय्याने शिक्षक क्षमता बांधणी व व्यावसायिक विकासाच्या प्रक्रियेत सहभागी होतात.",
        },
    ...
    en: {
      orangeDesc:
        "3.5.1. With the help of professional development institutions like SCERT / DIET, teachers participate in the process of capacity building and professional development.",
      options: [
        {
          text: "1.1 With the help of professional development institutions like SCERT / DIET, teachers participate in the process of capacity building and professional development.",
        },
  ...
  85: {
    mr: {
      orangeDesc:
        "३.५.२. शाळेच्या एकूण उपलब्ध वेळेपैकी शिक्षकांकडे अध्यापनाकरिता वापरलेल्या वेळेची टक्केवारी / प्रमाण.",
      options: [
        {
          text: "१.१ अध्यापकीय तसेच अध्यापनाव्यतिरिक्त कामे यासाठी शाळा/शाळेत विचारपूर्वक कृती आराखडा व वेळापत्रक तयार करते/केला जातो.",
        },
    ...
    en: {
      orangeDesc:
        "3.5.2. Percentage / proportion of time used for teaching by teachers out of the total available school time.",
      options: [
        {
          text: "1.1 The school prepares/makes a thoughtful action plan and timetable for teaching as well as non-teaching tasks.",
        },
  ...
  86: {
    mr: {
      orangeDesc:
        "३.५.३ शिक्षकांचे वर्गातील एकंदरीत कामगिरीबाबत पालक व विद्यार्थ्यांचे अभिप्राय.",
      options: [
        {
          text: "१.१ शिक्षक-पालकसंघ सभेमध्ये पालकांची उपस्थिती लक्षणीय आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1ELnMUe9Up-j98rY6G3-ZjHPtSTItE",
    },
    en: {
      orangeDesc:
        "3.5.3 Feedbacks of parents and students regarding the overall performance of teachers in the classroom.",
      options: [
        {
          text: "1.1 Parents' attendance in parent-teacher association meetings is significant.",
        },
  ...
  87: {
    mr: {
      orangeDesc:
        "४.१.१ शाळा दिव्यांग आणि सर्व सामाजिक आर्थिक पार्श्वभूमीतील विद्यार्थ्यांना भौतिक वातावरणाच्या दृष्टीने (रॅम्प, हँड्रील, अपंगासाठी अनुकूल शौचालय) अडथळा मुक्त प्रवेश प्रदान करते.",
      options: [
        {
          text: "१.१ सर्वसमावेशक विद्यार्थ्यांकरिता शाळेत पायाभूत सुविधा उपलब्ध आहेत.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1EO4LqhtplBN7elBebWibu71s37_",
    },
    en: {
      orangeDesc:
        "4.1.1 The school provides barrier-free access in terms of physical environment (ramps, handrails, disabled-friendly toilets) to disabled students and students from all socio-economic backgrounds.",
      options: [
        {
          text: "1.1 Infrastructure facilities are available in the school for inclusive students.",
        },
  ...
  88: {
    mr: {
      orangeDesc:
        "४.१.२ शाळा दिव्यांग विद्यार्थ्यांना अभ्यासक्रमाच्या दृष्टीने अडथळा मुक्त प्रवेश प्रदान करते.",
      options: [
        {
          text: "१.१ वर्ग आंतरक्रियेत दिव्यांग, आर्थिक, सामाजिक पार्श्वभूमीतील विद्यार्थ्यांचा समावेश केला जातो.",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1EOAACWijMYC7MD8f3_BCoSr9QsFtUerh",
    },
    en: {
      orangeDesc:
        "4.1.2 The school provides barrier-free access in terms of curriculum to disabled students.",
      options: [
        {
          text: "1.1 Disabled, socio-economically disadvantaged students are included in classroom interaction.",
          isGreen: true,
  ...
  89: {
    mr: {
      orangeDesc:
        "४.१.३ शाळा दिव्यांग विद्यार्थ्यांना शिकविण्याच्या आणि मूल्यमापनाबाबत अडचणीमुक्त प्रवेश प्रदान करते.",
      options: [
        {
          text: "१.१ शिक्षक दिव्यांग विद्यार्थ्यांना इतर विद्यार्थ्यांसोबत शिकवतात व मूल्यमापन करतात.",
          isGreen: true,
    ...
    en: {
      orangeDesc:
        "4.1.3 The school provides barrier-free access in terms of teaching and evaluation to disabled students.",
      options: [
        {
          text: "1.1 Teachers teach and evaluate disabled students along with other students.",
          isGreen: true,
  ...
  90: {
    mr: {
      orangeDesc:
        "४.१.४ दिव्यांग विद्यार्थ्यांना अडथळा विरहित शिक्षण घेण्यासाठी आर्थिक सहाय्य व साहित्य साधने पुरविली जातात.",
      options: [
        {
          text: "१.१ शाळा शैक्षणिक / आर्थिक सेवा सुविधा लाभार्थी यादी तयार करते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1mCRFeHsTDmFaDPpBf4mSBFUT-dOBxY9M-",
    },
    en: {
      orangeDesc:
        "4.1.4 Disabled students are provided with financial assistance and materials/tools to access barrier-free education.",
      options: [
        {
          text: "1.1 The school prepares a list of beneficiaries of educational / financial services and facilities.",
        },
  ...
  91: {
    mr: {
      orangeDesc:
        "४.२.१ शाळा दिव्यांग विद्यार्थ्यांना पुरेसा बैठे आणि मैदानी खेळ तसेच इतर मनोरंजनाच्या सुविधा पुरविते.",
      options: [
        {
          text: "१.१ दिव्यांग विद्यार्थी शाळेच्या बैठे खेळ आणि मैदानी खेळामध्ये व इतर कृतीमध्ये सहभागी होतात.",
          isGreen: true,
    ...
    en: {
      orangeDesc:
        "4.2.1 The school provides adequate indoor and outdoor sports as well as other recreational facilities for disabled students.",
      options: [
        {
          text: "1.1 Disabled students participate in school indoor sports and outdoor sports and other activities.",
          isGreen: true,
  ...
  92: {
    mr: {
      orangeDesc:
        "४.३.१ शाळा दिव्यांगाना पुरेशी वाहतूक सुविधा पुरवते. (मानकानुसार वाहतूक सुविधा पुरविणाऱ्या शाळांच्या बाबतीत)",
      options: [
        {
          text: "१.१ शाळेतील इतर मुलांसह दिव्यांग मुलांनाही वाहतूक सुविधा पुरविली जाते.",
        },
    ...
    en: {
      orangeDesc:
        "4.3.1 The school provides adequate transport facilities to disabled students (for schools providing transport facilities as per standards).",
      options: [
        {
          text: "1.1 Transport facility is provided to disabled children along with other children in the school.",
        },
  ...
  93: {
    mr: {
      orangeDesc:
        "४.४.१ शाळा सर्व सामाजिक, आर्थिक व वंचित पार्श्वभूमीतील आणि दिव्यांग विद्यार्थ्यांबाबत सर्व भागधारकांसाठी प्रशिक्षण आणि जाणीव जागृतीविषयक कार्यक्रम आयोजित करते.",
      options: [
        {
          text: "१.१ शाळेकडे समता, समानता व समावेशनाबाबत धोरण आहे.",
        },
    ...
    en: {
      orangeDesc:
        "4.4.1 The school organizes training and awareness programs for all stakeholders regarding students from all social, economic, and disadvantaged backgrounds, and disabled students.",
      options: [
        {
          text: "1.1 The school has a policy on equity, equality, and inclusion.",
        },
  ...
  94: {
    mr: {
      orangeDesc:
        "४.५.१ शाळा विद्यार्थी सर्व्हेक्षणाद्वारे शाळाबाह्य बालकांचा मागोवा घेते.",
      options: [
        {
          text: "१.१ शाळा नियमितपणे विद्यार्थी पटनोंदणी सर्वेक्षण करते व नोंदणीकृत विद्यार्थ्यांचा मागोवा घेते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1EzfcyGjMuW1XolVe7nCyopoHkLT6",
    },
    en: {
      orangeDesc:
        "4.5.1 The school tracks out-of-school children through student surveys.",
      options: [
        {
          text: "1.1 The school regularly conducts student enrollment surveys and tracks enrolled students.",
        },
  ...
  95: {
    mr: {
      orangeDesc:
        "४.६.१ शाळा दिव्यांगासाठी विशेष शिक्षक किंवा प्रशिक्षित शिक्षक उपलब्ध करुन देते व शिक्षकांची क्षमतावृद्धी करते.",
      options: [
        {
          text: "१.१ शाळेत दिव्यांगांच्या गरजा ओळखून त्यानुसार विशेष शिक्षक किंवा प्रशिक्षित शिक्षकांची नियुक्ती केली जाते.",
        },
    ...
    en: {
      orangeDesc:
        "4.6.1 The school provides special teachers or trained teachers for disabled students and builds the capacity of teachers.",
      options: [
        {
          text: "1.1 The school appoints special educators or trained teachers identifying the needs of disabled students.",
        },
  ...
  96: {
    mr: {
      orangeDesc:
        "४.७.१ विज्ञान, गणित, तंत्रज्ञान, कला, क्रीडा इत्यादी क्षेत्रातील विविध सामाजिक, आर्थिक पार्श्वभूमीतील प्रतिभावान मुलांना शाळा मार्गदर्शन करते.",
      options: [
        {
          text: "१.१ प्रतिभावान, हुशार मुले शोधण्यासाठी शाळा विविध प्रणाली/पद्धती/साधने वापरते.",
        },
    ...
    en: {
      orangeDesc:
        "4.7.1 The school guides talented children from diverse social and economic backgrounds in areas like science, mathematics, technology, art, sports, etc.",
      options: [
        {
          text: "1.1 The school uses various systems/methods/tools to identify talented, smart children.",
        },
  ...
  97: {
    mr: {
      orangeDesc:
        "४.८.१ शाळा शिक्षकांना मातृभाषा /स्थानिक /बोली भाषेत शिकविण्याचे शैक्षणिक साहित्य पुरविते.",
      options: [
        {
          text: "१.१ शाळा मातृभाषा व स्थानिक/प्रादेशिक भाषेत विद्यार्थी व शिक्षकांना शैक्षणिक साहित्य (TLM) उपलब्ध करून देते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1F3BrrwNtsh7WymgNo9a3AT7GhY9",
    },
    en: {
      orangeDesc:
        "4.8.1 The school provides teaching-learning materials to teachers for teaching in mother tongue / local / dialect language.",
      options: [
        {
          text: "1.1 The school provides teaching-learning materials (TLM) in mother tongue and local/regional language to students and teachers.",
        },
  ...
  98: {
    mr: {
      orangeDesc:
        "४.९.१. शाळा नियमितपणे दिव्यांगत्वासाठी शालेय, केंद्र व तालुका स्तरावर तपासणी शिबीरात सहभाग व आयोजन करते.",
      options: [
        {
          text: "१.१ शाळा दिव्यांगत्वासाठी नियमितपणे शाळा, केंद्र, तालुका स्तरावर तपासणी शिबिरात सहभागी होतात",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1F49H-Y_obbT5WduXIDvicgkqSEoOz60d",
    },
    en: {
      orangeDesc:
        "4.9.1 The school regularly participates in and organizes screening camps for disabilities at school, cluster, and taluka levels.",
      options: [
        {
          text: "1.1 The school regularly participates in screening camps for disabilities at school, cluster, and taluka levels.",
          isGreen: true,
  ...
  99: {
    mr: {
      orangeDesc:
        "४.१०.१ शाळा मुलींना भेदभाव विरहित क्रीडा, STEAM संधी, कलाशिक्षण, व्यवसायिक शिक्षण व संरक्षण प्रशिक्षण इत्यादी प्रदान करते तसेच संक्रमणाचा मागोवा घेऊन पुढील शिक्षणाची संधी देते.",
      options: [
        {
          text: "१.१ शाळेत मुलींना शिक्षणाच्या सर्व क्षेत्रात समान संधी देण्यास प्रोत्साहन व नियोजन केले जाते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1F4DJumLXFqD1dqEnuNQjja9bSrbgnz4u",
    },
    en: {
      orangeDesc:
        "4.10.1 The school provides girls with non-discriminatory sports, STEAM opportunities, art education, vocational education and safety training etc., and also tracks transition and provides opportunities for further education.",
      options: [
        {
          text: "1.1 The school encourages and plans to provide equal opportunities to girls in all areas of education.",
        },
  ...
  100: {
    mr: {
      orangeDesc:
        "४.११.१ शाळा सामाजिक, आर्थिकदृष्ट्या वंचित घटकांच्या(SEDGs) सर्व स्तरांवरील अध्ययन निष्पत्तीत सुधारणा करते.",
      options: [
        {
          text: "१.१ शाळेच्या दर्शनी भागात इयत्तानिहाय विषयनिहाय अध्ययन निष्पत्ती दर्शविण्यात आली आहे.",
          isGreen: true,
    ...
    en: {
      orangeDesc:
        "4.11.1 The school improves learning outcomes at all levels for Socially and Economically Disadvantaged Groups (SEDGs).",
      options: [
        {
          text: "1.1 Grade-wise and subject-wise learning outcomes are displayed in the front area of the school.",
          isGreen: true,
...
=======
    ...
    en: {
      orangeDesc:
        "5.1.1 The school functions as per its vision and mission statement and standards.",
      options: [
        {
          text: "1.1 The school has a written vision and mission statement.\n1.2 The statement considers the values and opportunities for intellectual and social development of students.",
        },
  ...
  102: {
    mr: {
      orangeDesc:
        "५.२.१ शालेय अल्पकालीन व दीर्घकालीन नियोजन हे संस्थात्मक नियोजनाच्या दृष्टी आणि ध्येय विधानाशी सुसंगत आहे.",
      options: [
        {
          text: "१.१ शाळा प्रमुखांच्या मार्गदर्शनाखाली शिक्षक आपल्या दैनंदिन कामकाजाचे नियोजन करतात.",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1FEHoHqvdAka8nK93lYoUnfz2YOs",
    },
    en: {
      orangeDesc:
        "5.2.1 School short-term and long-term planning is consistent with the institutional planning's vision and mission statement.",
      options: [
        {
          text: "1.1 Teachers plan their daily work under the guidance of the school head.",
          isGreen: true,
  ...
  103: {
    mr: {
      orangeDesc:
        "५.३.१ शालेय नेतृत्व / व्यवस्थापन हे शाळा आणि शाळेबाहेरील समुदायामध्ये प्रभावी समन्वय सुनिश्चित करते.",
      options: [
        {
          text: "१.१ शाळेचे व्यवस्थापन, शाळा सनियंत्रण समिती व शाळा प्रमुख यांच्यामध्ये सहकार्यात्मक प्रभावी कामकाजाचा समन्वय आहे.",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1FERrHV8HAYnNRqq4FtIm8mZr9P4hMkp7",
    },
    en: {
      orangeDesc:
        "5.3.1 School leadership / management ensures effective coordination within the school and with the community outside the school.",
      options: [
        {
          text: "1.1 There is cooperative and effective coordination of work among the school management, school monitoring committee, and school head.",
          isGreen: true,
...
=======
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1FMAjTo0UDZrdA0q6aggch4U0NzRX_Hk-",
    },
    en: {
      orangeDesc: "5.4.1 A mechanism for resource management is operational.",
      options: [
  ...
  105: {
    mr: {
      orangeDesc:
        "५.४.२ संसाधनांचा अपव्यय कमी करण्याच्या परिणामकारकतेच्या दृष्टीने शाळेच्या प्रगतीवर सनियंत्रण ठेवण्यासाठी योग्य यंत्रणा अस्तित्वात आहे.",
      options: [
        {
          text: "१.१ संसाधनांचा अपव्यय कमी करण्याच्या दृष्टीने शाळेकडे परिणामकारक व योग्य यंत्रणा आहे.\n१.२ पायाभूत सुविधा आणि प्रशासकीय व शैक्षणिक पैलूचे निरीक्षण व पुनरावलोकन ठराविक कालावधीत केले जाते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1FPr-10Qr7stj1gb57CzBNke3-byXSvay",
    },
    en: {
      orangeDesc:
        "5.4.2 An appropriate mechanism exists for monitoring the school's progress in terms of effectiveness in reducing resource wastage.",
      options: [
        {
          text: "1.1 The school has an effective and appropriate mechanism for reducing resource wastage.\n1.2 Infrastructure and administrative and academic aspects are inspected and reviewed periodically.",
        },
...
=======
    ...
    en: {
      orangeDesc:
        "5.5.1 A formal mechanism exists for school relationship management.",
      options: [
        {
          text: "1.1 School staff accept parents' concerns.",
        },
...
=======
    ...
    en: {
      orangeDesc:
        "5.5.2 The school's per child expenditure is appropriate and effective.",
      options: [
        {
          text: "1.1 The school expenditure plan is ready.\n1.2 All financial SOPs are available.\n1.3 Fee collection is done as per the required policy.",
        },
  ...
  108: {
    mr: {
      orangeDesc:
        "५.६.१ शाळेमध्ये संपूर्ण उपक्रमांची व्यवस्थापन यंत्रणा उपलब्ध आहे.",
      options: [
        {
          text: "१.१ शालेय उपक्रम आणि वार्षिक दिनदर्शिका तयार केली आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1FjYaFggWwXCrcfCqe5uqwWaq4qx3JCGI",
    },
    en: {
      orangeDesc:
        "5.6.1 A complete activity management system is available in the school.",
      options: [
        {
          text: "1.1 School activities and annual calendar have been prepared.",
        },
  ...
  109: {
    mr: {
      orangeDesc:
        "५.७.१ शाळेमध्ये माहिती आणि अभिलेखे देखभाल करण्याची परिपूर्ण प्रणाली आहे.",
      options: [
        {
          text: "१.१ दस्तऐवजीकरणाच्या सर्व मानकांची शाळा पूर्तता करते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1Fk29K1-volaIbZnVjUAvsyKMu5hnzWF-",
    },
    en: {
      orangeDesc:
        "5.7.1 The school has a comprehensive system for maintaining information and records.",
      options: [
        {
          text: "1.1 The school fulfills all documentation standards.",
        },
  ...
  110: {
    mr: {
      orangeDesc:
        "५.८.१ नियमित आणि प्रभावी मौखिक / आभासी / ऑनलाईन /लिखित संप्रेषण प्रणाली अस्तित्वात असून कार्यरत आहे.",
      options: [
        {
          text: "१.१ भागधारकांसोबत संवाद करण्यासाठी मौखिक संभाषण वापरले जाते.",
        },
    ...
    en: {
      orangeDesc:
        "5.8.1 A regular and effective oral / virtual / online / written communication system exists and is operational.",
      options: [
        {
          text: "1.1 Oral communication is used to communicate with stakeholders.",
        },
  ...
  111: {
    mr: {
      orangeDesc:
        "५.९.१ शाळेकडे दस्तऐवज ठेवणे, ताळेबंद, लेखापरीक्षण यासह वित्तीय व शुल्क नियमनासाठी यंत्रणा कार्यरत आहे.",
      options: [
        {
          text: "१.१ आर्थिक व्यवहार केले जातात परंतु अंशतः दस्तऐवज राखले जातात.",
        },
    ...
    en: {
      orangeDesc:
        "5.9.1 The school has a mechanism for financial and fee regulation including document keeping, balance sheet, and auditing.",
      options: [
        {
          text: "1.1 Financial transactions are done but documents are partially maintained.",
        },
  ...
  112: {
    mr: {
      orangeDesc:
        "५.१०.१ शाळा प्रवेश धोरण आणि प्रक्रिया ही भेदभावरहित, तर्कसंगत, पारदर्शक आणि प्रचलित मार्गदर्शक तत्वे, आर. टी.ई. २००९ मार्गदर्शक तत्वे आणि निकषांशी सुसंगत आहे.",
      options: [
        {
          text: "१.१ शाळा प्रवेश प्रक्रिया भेदभावरहित, पारदर्शक आणि प्रचलित मार्गदर्शक तत्वांशी सुसंगत आहे.\nत्याचबरोबर आर.टी.ई. कायद्याच्या तत्वांच्या अनुरूप व नियमानुसार आहे.\n१.२ धर्म, वंश, जात, पंथ, जन्मस्थान असा कोणताही भेदभाव न करता प्रवेश दिला जातो.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1FmXL2EivhbpVrkE_3mjec3zj1vxev3XE",
    },
    en: {
      orangeDesc:
        "5.10.1 The school admission policy and process is non-discriminatory, rational, transparent and consistent with prevailing guidelines, R.T.E. 2009 guidelines and criteria.",
      options: [
        {
          text: "1.1 The school admission process is non-discriminatory, transparent and consistent with prevailing guidelines.\nIt is also in accordance with the provisions and regulations of the R.T.E. Act.\n1.2 Admission is given without any discrimination of religion, race, caste, creed, or birthplace.",
        },
  ...
  113: {
    mr: {
      orangeDesc:
        "५.१०.२ SC / ST /OBC / अल्पसंख्यांक यांसारख्या वंचित समुदायांवर व शाळाबाह्य विद्यार्थ्यांवर लक्ष केंद्रित करून जवळपासच्या भागात नियमित प्रवेश प्रक्रियेचे अवलंबन करते.",
      options: [
        {
          text: "१.१ शाळा शाळाबाह्य विद्यार्थ्यांसाठी गृहभेटीतून सर्वेक्षण करते.",
        },
    ...
    en: {
      orangeDesc:
        "5.10.2 Focuses on disadvantaged communities like SC/ST/OBC/minorities and out-of-school students and follows regular admission process in nearby areas.",
      options: [
        {
          text: "1.1 The school conducts surveys through home visits for out-of-school students.",
        },
...
=======
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1FpcjsYBLhfj0c9hPHFdErLMzaAdcnhfO",
    },
    en: {
      orangeDesc: "5.11.1 School Complex.",
      options: [
  ...
  115: {
    mr: {
      orangeDesc:
        "५.११.२ शाळा प्रमुख शाळेतील प्रणाली सुधारण्याची क्षमता प्रदर्शित करतात आणि जबाबदारी व उत्तरदायित्वाची नैतिकता सुनिश्चित करतात.",
      options: [
        {
          text: "१.१ शाळेतील प्रणाली सुधारण्यासाठी, जबाबदारी आणि उत्तरदायित्वाची नैतिकता सुनिश्चित करण्यासाठी शिक्षकांची क्षमता वाढवली जाते.",
        },
    ...
    en: {
      orangeDesc:
        "5.11.2 School heads demonstrate the ability to improve school systems and ensure the ethics of responsibility and accountability.",
      options: [
        {
          text: "1.1 Teachers' capacity is enhanced to improve school systems and ensure ethics of responsibility and accountability.",
        },
  ...
  116: {
    mr: {
      orangeDesc:
        "५.११.३ शाळा प्रमुख विद्यार्थ्यांना व शाळेला एकविसाव्या शतकातील कौशल्यांनी सज्ज करतील अशा सर्जनशील पद्धती व तंत्रांची ओळख करून देऊन नाविण्यतेला प्रोत्साहित करतात.",
      options: [
        {
          text: "१.१ शाळा प्रमुख विद्यार्थ्यांना एकविसाव्या शतकातील कौशल्य प्राप्त करण्यासाठी सर्जनशील पद्धती आणि तंत्राचा परिचय करून देण्यासाठी शिक्षकांसाठी क्षमता वृद्धी कार्यक्रमाची बांधणी करतात.",
        },
    ...
    en: {
      orangeDesc:
        "5.11.3 School heads encourage innovation by introducing creative methods and techniques that will equip students and the school with 21st century skills.",
      options: [
        {
          text: "1.1 School heads build capacity building programs for teachers to introduce creative methods and techniques for students to acquire 21st century skills.",
        },
  ...
  117: {
    mr: {
      orangeDesc:
        "५.१२.१ शाळा PRABANDH, UDISE+, राष्ट्रीय व राज्य विद्या समीक्षा केंद्र (VSK) यांवर निर्धारित वेळेत माहिती भरते.",
      options: [
        {
          text: "१.१ शाळा PGI, PRABANDH, UDISE+ यांवर वर्षातून किमान दोनदा माहिती परिपूर्ण भरते.\n१.२ PGI, SQAAF संदर्भातील माहिती वेळेत भरली जाते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1FsrrVDXcwG-vO8bBod-ILfhZNVpF5Eqi",
    },
    en: {
      orangeDesc:
        "5.12.1 The school fills information on PRABANDH, UDISE+, National and State Vidya Samiksha Kendra (VSK) within the stipulated time.",
      options: [
        {
          text: "1.1 The school fills complete information on PGI, PRABANDH, UDISE+ at least twice a year.\n1.2 PGI, SQAAF related information is filled on time.",
        },
  ...
  118: {
    mr: {
      orangeDesc:
        "६.१.१ शाळा विद्यार्थ्यांना शैक्षणिक धोरणावर मते व सूचना मांडण्याची आणि शालेय निर्णयप्रक्रियेत सहभागी होण्याची संधी उपलब्ध करून देते.",
      options: [
        {
          text: "१.१. विद्यार्थी प्रतिनिधींची निवड सर्वानुमते केली जाते.\n१.२ शाळा विद्यार्थ्यांना शैक्षणिक धोरणांवर स्वतःची मते आणि सूचना व्यक्त करण्यासाठी संधी उपलब्ध करून देते.",
        },
    ...
    en: {
      orangeDesc:
        "6.1.1 The school provides students with the opportunity to express opinions and suggestions on educational policy and to participate in school decision-making processes.",
      options: [
        {
          text: "1.1. Student representatives are selected unanimously.\n1.2 The school provides students with the opportunity to express their own opinions and suggestions on educational policies.",
        },
...
=======
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1FwACy2w8FL51aO0GxPN1ygBosMDPc5Vr",
    },
    en: {
      orangeDesc:
        "6.1.2 The school creates a conducive environment for joyful learning.",
      options: [
        {
          text: "1.1 The school provides joyful learning to all students in a conducive environment.",
        },
  ...
  120: {
    mr: {
      orangeDesc:
        "६.१.३ विद्यार्थी नियमितपणे शालेय सुरक्षा, पाणी, पर्यावरण संवर्धन, स्वच्छता (सांडपाणी, घनकचरा व्यवस्थापन इ.) इत्यादींचा लेखाजोखा मांडण्याच्या व व्यवस्थापनाच्या प्रक्रियेत सहभागी होतो.",
      options: [
        {
          text: "१.१ शालेय सुरक्षा, पाणी, पर्यावरण संवर्धन, स्वच्छताबाबतचे परीक्षण मुद्देसूद मांडण्याची मार्गदर्शक तत्वे शाळेकडे उपलब्ध आहेत.",
        },
    ...
    en: {
      orangeDesc:
        "6.1.3 Students regularly participate in the process of accounting and management of school safety, water, environment conservation, cleanliness (wastewater, solid waste management, etc.).",
      options: [
        {
          text: "1.1 The school has guidelines for presenting the review of school safety, water, environment conservation, and cleanliness in a pointed manner.",
        },
  ...
  121: {
    mr: {
      orangeDesc:
        "६.१.४ अध्ययन - अध्यापन प्रक्रिया, मूल्यमापन, विविध उपक्रम, भौतिक सोयी - सुविधाबद्दल समाधानी आहेत.",
      options: [
        {
          text: "१.१ विद्यार्थी वर्गातील अध्ययन - अध्यापन प्रक्रिया, मूल्यमापन, विविध उपक्रमाचा लाभ घेतात तसेच भौतिक सोयी - सुविधांचा वापर करतात.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1FwjNCUVnrcdEbKrf_EwB9iq0rVMJT",
    },
    en: {
      orangeDesc:
        "6.1.4 Students are satisfied with the learning-teaching process, evaluation, various activities, and physical facilities.",
      options: [
        {
          text: "1.1 Students benefit from the learning-teaching process, evaluation, various activities in the classroom and use physical facilities.",
        },
  ...
  122: {
    mr: {
      orangeDesc:
        "६.२.१ शाळा शिक्षकांना त्यांचा अभिप्राय देण्यासाठी निर्धोक, भयमुक्त आणि काळजी घेणारे वातावरण तयार करते आणि या अभिप्रायाचे वेळोवेळी पुनरावलोकन करण्यासाठी आणि शिक्षकांच्या सुधारणा, नियोजन आणि मूल्यांकन यासाठीची यंत्रणा विकसित करते.",
      options: [
        {
          text: "१.१ शिक्षक शाळा सुधारणा, शाळा व्यवस्थापन समिती व शाळा व्यवस्थापन विकास समिती शाळा विकास आराखडा रचनेमध्ये सक्रिय सहभागी होतात.\n१.२ शिक्षकांना त्यांच्या शैक्षणिक व व्यावसायिक अर्हता विकासाची संधी दिली जाते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1G-CIxiELuEI-Mem6oF0WeWxM2Sa9sx6T",
    },
    en: {
      orangeDesc:
        "6.2.1 The school creates a safe, fear-free and caring environment for teachers to give their feedback and develops a mechanism for periodically reviewing this feedback and for teachers' improvement, planning and evaluation.",
      options: [
        {
          text: "1.1 Teachers actively participate in school improvement, School Management Committee and School Management Development Committee school development plan formulation.\n1.2 Teachers are given opportunities for their educational and professional qualification development.",
        },
  ...
  123: {
    mr: {
      orangeDesc:
        "६.२.२ शैक्षणिक प्रशिक्षण संस्थेच्या प्रशिक्षण नोंदणी योजना, पुरस्कार व इतर कृतीबाबत शिक्षक समाधानी आहेत.",
      options: [
        {
          text: "१.१. शाळा शिक्षकांना त्यांच्या क्षमता विकासासाठी योग्य वातावरण प्रदान करते.",
        },
    ...
    en: {
      orangeDesc:
        "6.2.2 Teachers are satisfied with the training registration scheme, awards and other activities of the educational training institution.",
      options: [
        {
          text: "1.1. The school provides a suitable environment for teachers for their capacity development.",
        },
  ...
  124: {
    mr: {
      orangeDesc:
        "६.३.१ शाळा कार्यालयीन कर्मचाऱ्यांना सुधारणाविषयक त्यांचे मत, सूचना व्यक्त करण्याची संधी देते.",
      options: [
        {
          text: "१.१ शाळेकडे तक्रार निवारण यंत्रणा उपलब्ध आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1G37yIWcnsWh2uCyn6UK9yJfPaH",
    },
    en: {
      orangeDesc:
        "6.3.1 The school gives office staff the opportunity to express their opinions and suggestions regarding improvements.",
      options: [
        {
          text: "1.1 The school has a grievance redressal mechanism available.",
        },
  ...
  125: {
    mr: {
      orangeDesc:
        "६.४.१ शाळा व्यवस्थापन समिती, प्रशासकीय विभाग, शिक्षणसंस्था, व्यवस्थापन इत्यादी मुख्याध्यापकांना त्यांच्या सूचना, विचार आणि चिंता व्यक्त करण्यासाठी एक कार्यप्रणाली प्रदान करतात आणि सुधारणा करण्यासाठी वेळोवेळी पुनरावलोकन आणि मूल्यांकन करतात.",
      options: [
        {
          text: "१.१ प्रशासन, शाळा व्यवस्थापन समिती, शाळा व्यवस्थापन विकास समिती, शिक्षक, कर्मचारी, पालक, विद्यार्थी यांचे मुख्याध्यापकांना सहकार्य लाभते.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1G6vKvcd1uvKCVPGyccbSnO-GkzHVGi4l",
    },
    en: {
      orangeDesc:
        "6.4.1 The School Management Committee, administrative department, educational institution, management etc. provide a mechanism for headmasters to express their suggestions, thoughts and concerns and periodically review and evaluate for improvements.",
      options: [
        {
          text: "1.1 Administration, School Management Committee, School Management Development Committee, teachers, staff, parents, students provide cooperation to headmasters.",
        },
  ...
  126: {
    mr: {
      orangeDesc:
        "६.५.१ शाळा पालकांचे, माजी विद्यार्थ्यांचे शाळेच्या प्रक्रियेबद्दल अभिप्राय घेते त्यानुसार शालेय कार्यक्षमतेत सुधारणा आणि त्यांच्या समाधानाचे मूल्यांकन करण्यासाठी एक प्रभावी व्यासपीठ उपलब्ध करून देते.",
      options: [
        {
          text: "१.१ शाळा पालक, माजी विद्यार्थी यांचा वर्षातून एकदा मेळावा आयोजित करते.",
          isGreen: true,
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1GDsdHZ2G4ot4abRNsEsmEJiewZJ9AE24",
    },
    en: {
      orangeDesc:
        "6.5.1 The school takes feedback from parents and alumni about school processes, provides an effective platform for improving school efficiency and evaluating their satisfaction.",
      options: [
        {
          text: "1.1 The school organizes a meeting of parents and alumni once a year.",
          isGreen: true,
  ...
  127: {
    mr: {
      orangeDesc:
        "६.६.१ शाळेचे मुख्याध्यापक सामाजिक उत्तरदायित्व संबंधित कार्यक्रम जसे - परिसर स्वच्छता, नवसाक्षरता व प्रौढ शिक्षण, पर्यावरणदूत, पर्यावरण संरक्षण, सांस्कृतिक वारसा जतन, वृद्धाश्रमांसोबत काम इत्यादी बाबींचा कार्यक्रम तयार करतात आणि सर्व वयोगटासाठी वार्षिक अभ्यासक्रम योजनेत त्यांचा समावेश करतात.",
      options: [
        {
          text: "१.१ शाळा मुख्याध्यापक सर्व वयोगटांसाठी वार्षिक नियोजन करतात आणि समाजोपयोगी कार्यक्रमाचे उपयोजन करतात.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1GGW9K8BcKk3zMICHpCLsLroGeMF4oZoW",
    },
    en: {
      orangeDesc:
        "6.6.1 The school's headmaster prepares programs related to social responsibility such as - neighborhood cleanliness, neo-literacy and adult education, environment ambassador, environment protection, cultural heritage preservation, working with old age homes etc. and includes them in the annual curriculum plan for all age groups.",
      options: [
        {
          text: "1.1 The school headmaster does annual planning for all age groups and implements socially useful programs.",
        },
  ...
  128: {
    mr: {
      orangeDesc:
        "६.७.१ व्यवस्थापन, शिक्षक पालक संघ (P.T.A.), शाळा व्यवस्थापन समिती/शाळा व्यवस्थापन विकास समितीचे पदाधिकारी शाळेच्या VISION व MISSION यांचे पुनरावलोकन करून मूल्यांकन व सतत सुधारणा करण्याची कार्यप्रणाली विकसित करते.",
      options: [
        {
          text: "१.१ शाळेच्या VISION व MISSION पुनरावलोकन करण्याची कार्यप्रणाली शिक्षक पालक संघ (P.T.A) शाळा व्यवस्थापन समिती/शाळा व्यवस्थापन विकास समिती कडे आहे.",
        },
      ...
      evidenceUrl:
        "https://drive.google.com/drive/folders/1GGX5O-Vsjffm_l-LDsrcFyBM8aHmuFGM",
    },
    en: {
      orangeDesc:
        "6.7.1 Management, Parent Teacher Association (P.T.A.), School Management Committee/School Management Development Committee officials review the school's VISION and MISSION and develop a system for evaluation and continuous improvement.",
      options: [
        {
          text: "1.1 The Parent Teacher Association (P.T.A), School Management Committee/School Management Development Committee has a system for reviewing the school's VISION and MISSION.",
        },
...
=======
  const [activeStandardDetails, setActiveStandardDetails] = useState<
    number | null
  >(null);
  const [pdfFormat, setPdfFormat] = useState<"table" | "responses">("table");
  const [previewPdfUrl, setPreviewPdfUrl] = useState<string | null>(null);
...
=======
  const [infoSchoolName, setInfoSchoolName] = useState(
    savedInfo?.schoolName || profile?.schoolName || "",
  );
  const [infoHeadmaster, setInfoHeadmaster] = useState(
    savedInfo?.headmaster || profile?.fullName || "",
  );
  const [infoAddress, setInfoAddress] = useState(
    savedInfo?.address || profile?.address || "",
  );
  const [infoCenterName, setInfoCenterName] = useState(
    savedInfo?.centerName || "",
  );
  const [infoTaluka, setInfoTaluka] = useState(savedInfo?.taluka || "");
  const [infoDistrict, setInfoDistrict] = useState(savedInfo?.district || "");
  const [infoUdise, setInfoUdise] = useState(
    savedInfo?.udise || profile?.udise || "",
  );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
    toast.success(
      selectedLang === "mr" ? "माहिती जतन केली." : "Information saved.",
    );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    setView("dashboard");
  };
        ...
        if (savedOptions) {
          try {
            ...
            opts.forEach((_: any, idx: number) => {
              localStorage.removeItem(`sqaaf_evidence_checked_${i}_${idx}`);
              localStorage.removeItem(`sqaaf_evidence_file_name_${i}_${idx}`);
<<<<<<< HEAD
              localStorage.removeItem(`sqaaf_evidence_file_preview_${i}_${idx}`);
=======
              localStorage.removeItem(
                `sqaaf_evidence_file_preview_${i}_${idx}`,
              );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
  ...
  const [card1Checked, setCard1Checked] = useState(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("sqaaf_card1_checked");
  ...
  const [card2Checked, setCard2Checked] = useState(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("sqaaf_card2_checked");
  ...
  const [card3Checked, setCard3Checked] = useState(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("sqaaf_card3_checked");
      return saved !== null ? saved === "true" : false;
    }
    return false;
  });
  ...
  const toggleCard1 = () => {
    ...
    localStorage.setItem("sqaaf_card1_checked", String(nextVal));
  };

  const toggleCard2 = () => {
    const nextVal = !card2Checked;
    setCard2Checked(nextVal);
    localStorage.setItem("sqaaf_card2_checked", String(nextVal));
  };

  const toggleCard3 = () => {
    const nextVal = !card3Checked;
    setCard3Checked(nextVal);
    localStorage.setItem("sqaaf_card3_checked", String(nextVal));
  };
  ...
  const [certSchoolName, setCertSchoolName] = useState(() => {
    if (typeof window !== "undefined") {
<<<<<<< HEAD
      return localStorage.getItem("sqaaf_cert_school_name") || infoSchoolName || profile?.schoolName || "Z.P SCHOOL DHONDEWADIPED";
=======
      return (
        localStorage.getItem("sqaaf_cert_school_name") ||
        infoSchoolName ||
        profile?.schoolName ||
        "Z.P SCHOOL DHONDEWADIPED"
      );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    }
  ...
  const [certUdise, setCertUdise] = useState(() => {
    if (typeof window !== "undefined") {
<<<<<<< HEAD
      return localStorage.getItem("sqaaf_cert_udise") || infoUdise || profile?.udise || "27350800701";
=======
      return (
        localStorage.getItem("sqaaf_cert_udise") ||
        infoUdise ||
        profile?.udise ||
        "27350800701"
      );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
  ...
  const [certTitleEn, setCertTitleEn] = useState(() => {
    if (typeof window !== "undefined") {
<<<<<<< HEAD
      return localStorage.getItem("sqaaf_cert_title_en") || "Self Assessment Completion Certificate";
=======
      return (
        localStorage.getItem("sqaaf_cert_title_en") ||
        "Self Assessment Completion Certificate"
      );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    }
  ...
  const [certTitleMr, setCertTitleMr] = useState(() => {
    if (typeof window !== "undefined") {
<<<<<<< HEAD
      return localStorage.getItem("sqaaf_cert_title_mr") || "स्वयं मूल्यमापन पूर्तता प्रमाणपत्र";
=======
      return (
        localStorage.getItem("sqaaf_cert_title_mr") ||
        "स्वयं मूल्यमापन पूर्तता प्रमाणपत्र"
      );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    }
  ...
  const [certDescEn, setCertDescEn] = useState(() => {
    if (typeof window !== "undefined") {
<<<<<<< HEAD
      return localStorage.getItem("sqaaf_cert_desc_en") || "has successfully completed the Self Assessment of the School Quality Assessment and Assurance Framework (SQAAF) for the Academic Year 2025-26, in accordance with the prescribed framework and guidelines";
=======
      return (
        localStorage.getItem("sqaaf_cert_desc_en") ||
        "has successfully completed the Self Assessment of the School Quality Assessment and Assurance Framework (SQAAF) for the Academic Year 2025-26, in accordance with the prescribed framework and guidelines"
      );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    }
  ...
  const [certDescMr, setCertDescMr] = useState(() => {
    if (typeof window !== "undefined") {
<<<<<<< HEAD
      return localStorage.getItem("sqaaf_cert_desc_mr") || "यांनी शैक्षणिक वर्ष २०२५-२६ साठी शालेय गुणवत्ता मूल्यमापन व खात्री आराखडा (SQAAF) अंतर्गत स्वयं मूल्यमापन विहित आराखडा आणि मार्गदर्शक तत्त्वांनुसार यशस्वीरित्या पूर्ण केले आहे.";
=======
      return (
        localStorage.getItem("sqaaf_cert_desc_mr") ||
        "यांनी शैक्षणिक वर्ष २०२५-२६ साठी शालेय गुणवत्ता मूल्यमापन व खात्री आराखडा (SQAAF) अंतर्गत स्वयं मूल्यमापन विहित आराखडा आणि मार्गदर्शक तत्त्वांनुसार यशस्वीरित्या पूर्ण केले आहे."
      );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    }
  ...
  const handleEditToggle = () => {
    if (isEditingCert) {
      ...
      localStorage.setItem("sqaaf_cert_udise", certUdise);
      localStorage.setItem("sqaaf_cert_title_en", certTitleEn);
      localStorage.setItem("sqaaf_cert_title_mr", certTitleMr);
      localStorage.setItem("sqaaf_cert_desc_en", certDescEn);
      localStorage.setItem("sqaaf_cert_desc_mr", certDescMr);
<<<<<<< HEAD
...
=======
  const currentDetail =
    activeStandardDetails !== null
      ? getStandardDetail(activeStandardDetails)
      : null;
...
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("sqaaf_last_selected_standard");
  ...
  const [savedScrollPosition, setSavedScrollPosition] = useState<number>(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("sqaaf_saved_scroll_position");
...
<<<<<<< HEAD
  const [savedWindowScrollPosition, setSavedWindowScrollPosition] = useState<number>(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("sqaaf_saved_window_scroll_position");
      return saved ? parseFloat(saved) : 0;
    }
    return 0;
  });
=======
  const [savedWindowScrollPosition, setSavedWindowScrollPosition] =
    useState<number>(() => {
      if (typeof window !== "undefined") {
        const saved = localStorage.getItem(
          "sqaaf_saved_window_scroll_position",
        );
        return saved ? parseFloat(saved) : 0;
      }
      return 0;
...
<<<<<<< HEAD
  ...
  const [completedStandards, setCompletedStandards] = useState<Set<number>>(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("sqaaf_completed_standards");
      if (saved) {
        try {
...
=======
    ...
    activeStandardDetails,
    view,
    savedScrollPosition,
    savedWindowScrollPosition,
  ]);
...
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("sqaaf_selected_options");
      if (saved) {
        try {
          return JSON.parse(saved);
        } catch (e) {
...
=======
      localStorage.setItem(
        "sqaaf_completed_standards",
        JSON.stringify(Array.from(updatedCompleted)),
      );
    }

    toast.success(
      selectedLang === "mr" ? `पर्याय निवडला.` : `Option selected.`,
    );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
  };
...
=======
    toast.success(
      nextLang === "mr" ? "भाषा बदलली: मराठी" : "Language changed to English",
    );
  };
  ...
  const handleDownloadPdf = async (formatOverride?: "table" | "responses") => {
    try {
      ...
      const toastId = toast.loading(
        pdfLang === "mr" ? "PDF तयार करत आहे..." : "Generating PDF...",
      );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
      ...
      const schoolName =
        schoolInfo?.schoolName || infoSchoolName || profile?.schoolName || "";
      const headmaster =
        schoolInfo?.headmaster || infoHeadmaster || profile?.fullName || "";
      const udise = schoolInfo?.udise || infoUdise || profile?.udise || "";
      const address =
        schoolInfo?.address || infoAddress || profile?.address || "";
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
          const idx =
            selectedOptionsMap[num.toString()] !== undefined
        ...
        const responseCards = answeredStandards
          .map(
            (s) => `
          <div style="background: #fff; border: 1.5px solid #e2e8f0; border-radius: 14px; padding: 20px 22px; page-break-inside: avoid; margin-bottom: 14px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
...
=======
        ...
        const totalAnswered = answeredStandards.filter(
          (s) => s.isSelected,
        ).length;

        const savedCompletedStds = localStorage.getItem(
          "sqaaf_completed_standards",
        );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
<<<<<<< HEAD
        ...
        const domainRowsLegacyHtml = domainsDataLegacy.map(dom => {
          ...
          const naText = naStds.length > 0 ? `<br/><span style='font-size:7px;'>${formatRanges(naStds)} लागू नाही</span>` : "";
          const dynamicRangeHtml = `${dom.start} ते ${dom.end}${naText}`;
...
=======
          {
            id: 1,
            rangeHtml:
              "१ ते ४४<br/><span style='font-size:7px;'>१० ते १६ लागू नाही</span>",
            nameMr: "क्षेत्र १ : अभ्यासक्रम,अध्यापनशास्त्र आणि मूल्यांकन",
            start: 1,
            end: 44,
          },
          {
            id: 2,
            rangeHtml:
              "४५ ते ७४<br/><span style='font-size:7px;'>६३- ते ६६ व ७३ ते-७४<br/>लागू नाही</span>",
            nameMr: "क्षेत्र २ : पायाभूत सुविधा",
            start: 45,
            end: 74,
          },
          {
            id: 3,
            rangeHtml: "७५ ते ८६",
            nameMr: "क्षेत्र ३ : मानवी संसाधने आणि शालेय नेतृत्व",
            start: 75,
            end: 86,
          },
          {
            id: 4,
            rangeHtml: "८७ ते १००",
            nameMr: "क्षेत्र ४ : समावेशित पद्धती आणि लिंगसमभाव",
            start: 87,
            end: 100,
          },
          {
            id: 5,
            rangeHtml: "१०० ते ११७",
            nameMr: "क्षेत्र ५ : व्यवस्थापन ,संनियंत्रण आणि प्रशासन",
            start: 101,
            end: 117,
          },
          {
            id: 6,
            rangeHtml: "११८ ते १२८",
            nameMr: "क्षेत्र ६ :लाभार्थ्यांचे समाधान",
            start: 118,
            end: 128,
          },
        ];
        ...
        let overallExtObt = 0,
          overallExtTot = 0;
        let totalApplicable = 0;
        const savedExternalOptions = localStorage.getItem(
          "sqaaf_external_options",
        );
        let externalOptionsMap: Record<string, number> = {};
        if (savedExternalOptions) {
          try {
            externalOptionsMap = JSON.parse(savedExternalOptions);
          } catch {}
        }

        const domainRowsLegacyHtml = domainsDataLegacy
          .map((dom) => {
            let selfL1 = 0,
              selfL2 = 0,
              selfL3 = 0,
            ...
            <tr style="page-break-inside: avoid;">
              <td style="border: 1px solid black; padding: 4px; text-align: center; font-size: 9px;">${dom.rangeHtml}</td>
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
              ...
              <td style="border: 1px solid black; padding: 4px; text-align: center; font-weight: bold;">${extL1 || ""}</td>
              <td style="border: 1px solid black; padding: 4px; text-align: center; font-weight: bold;">${extL2 || ""}</td>
              <td style="border: 1px solid black; padding: 4px; text-align: center; font-weight: bold;">${extL3 || ""}</td>
              <td style="border: 1px solid black; padding: 4px; text-align: center; font-weight: bold;">${extL4 || ""}</td>
              <td style="border: 1px solid black; padding: 4px; text-align: center; font-weight: bold;">${extObt}</td>
            </tr>
          `;
<<<<<<< HEAD
        }).join("");

        const domainRowsLegacyHtmlResponses = domainsDataLegacy.map(dom => {
          let selfL1 = 0, selfL2 = 0, selfL3 = 0, selfL4 = 0;
          let extL1 = 0, extL2 = 0, extL3 = 0, extL4 = 0;
          let selfObt = 0, extObt = 0;
          let appCount = 0;
...
=======
        const overallSelfPct =
          totalPossibleMarks > 0
            ? Math.round((obtainedMarks_ / totalPossibleMarks) * 100)
            : 0;
        const overallExtPct =
          overallExtTot > 0
            ? Math.round((overallExtObt / overallExtTot) * 100)
            : 0;
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
            <div class="html2pdf__page-break" style="page-break-before: always; padding-top: 20px; page-break-inside: avoid;">
              <table style="width: 100%; border-collapse: collapse; border: 1px solid black; font-size: 10px; font-family: 'Noto Sans Devanagari', Arial, sans-serif;">
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                <thead>
                  <tr>
                    <th rowspan="2" style="border: 1px solid black; padding: 4px; width: 60px;">मानक क्र.</th>
                    <th rowspan="2" style="border: 1px solid black; padding: 4px; width: 40px;">लागू मानके</th>
                    <th rowspan="2" style="border: 1px solid black; padding: 4px; width: 120px;">क्षेत्र</th>
                    <th colspan="5" style="border: 1px solid black; padding: 4px; text-align: center; background-color: #f8fafc;">स्वयं मूल्यमापन</th>
                    <th colspan="5" style="border: 1px solid black; padding: 4px; text-align: center; background-color: #f8fafc;">बाह्य मूल्यमापन</th>
                  </tr>
                  <tr>
                    <th style="border: 1px solid black; padding: 4px; width: 30px;">स्तर १</th>
                    <th style="border: 1px solid black; padding: 4px; width: 30px;">स्तर २</th>
                    <th style="border: 1px solid black; padding: 4px; width: 30px;">स्तर ३</th>
                    <th style="border: 1px solid black; padding: 4px; width: 30px;">स्तर ४</th>
                    <th style="border: 1px solid black; padding: 4px; width: 35px;">एकूण</th>
                    <th style="border: 1px solid black; padding: 4px; width: 30px;">स्तर १</th>
                    <th style="border: 1px solid black; padding: 4px; width: 30px;">स्तर २</th>
                    <th style="border: 1px solid black; padding: 4px; width: 30px;">स्तर ३</th>
                    <th style="border: 1px solid black; padding: 4px; width: 30px;">स्तर ४</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colspan="4" style="border: 1px solid black; padding: 4px;"></td>
                    <td style="border: 1px solid black; padding: 4px; text-align: center; font-weight: bold;">${overallExtObt}</td>
                  </tr>
                  <tr>
                    ...
                    <td colspan="4" style="border: 1px solid black; padding: 4px;"></td>
                    <td style="border: 1px solid black; padding: 4px; text-align: center; font-weight: bold;">${overallExtTot}</td>
                  </tr>
                  <tr>
                    <td colspan="2" style="border: 1px solid black; padding: 4px;"></td>
                    ...
                    <td colspan="4" style="border: 1px solid black; padding: 4px;"></td>
                    <td style="border: 1px solid black; padding: 4px; text-align: center; font-weight: bold;">${overallExtPct}%</td>
                  </tr>
                  <tr>
                    <td colspan="2" style="border: 1px solid black; padding: 4px;"></td>
                    ...
                    <td colspan="4" style="border: 1px solid black; padding: 4px;"></td>
                    <td style="border: 1px solid black; padding: 4px; text-align: center; font-weight: bold;">${getGrade(overallExtPct)}</td>
                  </tr>
                </tbody>
              </table>
...
<<<<<<< HEAD
          ...
          const isExtNotApplicable = extIdx === options.length - 1;
=======
          const orangeDesc =
            langData?.orangeDesc ||
            (isMr
          ...
          const extIdx =
            externalOptionsMap[num.toString()] !== undefined
              ? externalOptionsMap[num.toString()]
              : undefined;
          const hasExt = extIdx !== undefined && extIdx !== null;
...
<<<<<<< HEAD
          const isCellSelected = (levelIdx: number) => isSelected && Number(selectedIdx) === levelIdx;
...
=======
          const isCellSelected = (levelIdx: number) =>
            isSelected && Number(selectedIdx) === levelIdx;

          const cellStyle = (levelIdx: number) => {
            if (!isSelected) return "";
            if (isNotApplicable)
              return "background-color: #e5e7eb; color: #9ca3af;";
            if (isCellSelected(levelIdx))
              return "background-color: #dcfce7; border: 2px solid #22c55e; font-weight: 700;";
            return "";
          };
          ...
          const extStyle = hasExt
            ? isExtNotApplicable
              ? "background-color: #e5e7eb; color: #9ca3af;"
              : "background-color: #e0e7ff; font-weight: 900; font-size: 14px; color: #3730a3;"
            : "";

          return `
            <tr style="page-break-inside: avoid; ${isNotApplicable ? "opacity: 0.6;" : ""}">
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
<<<<<<< HEAD
      ...
      if (currentFormat === "table") {
        ...
        let totalPossible = 0;
        for (let i = 1; i <= 128; i++) {
           const selectedIdx = externalOptions[i];
           if (selectedIdx !== undefined && selectedIdx !== null && selectedIdx !== -1) {
               const options = getGroupedOptions(i, pdfLang);
               const isNA = selectedIdx === options.length - 1;
               if (!isNA) {
        ...
        `;
        currentPage.innerHTML = headerHtml;
        ...
        if (action === "download") {
         ...
         const pdfOptions = {
            ...
            filename: `SQAAF_Responses_${schoolName.replace(/\s+/g, "_") || "School"}_${new Date().toISOString().slice(0, 10)}.pdf`,
            image: { type: "jpeg", quality: 1.0 },
            html2canvas: { scale: 3.0, useCORS: true, logging: false },
         ...
         if (action === "download") {
            ...
            html2pdf().set(pdfOptions).from(container).output('bloburl').then((url: string) => {
              window.open(url, "_blank");
              document.body.removeChild(container);
              toast.dismiss(toastId);
              toast.success(pdfLang === "mr" ? "PDF उघडली आहे." : "PDF opened.");
...
=======
      ...
      toast.success(
        pdfLang === "mr"
          ? "PDF तयार झाली! प्रिव्ह्यू पहा."
          : "PDF Ready! Check the preview.",
      );
    } catch (err) {
      console.error("PDF generation error:", err);
      toast.error(
        pdfLang === "mr" ? "PDF बनवताना त्रुटी आली." : "Error generating PDF.",
      );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    }
  };
...
=======
      ...
      <main
        className={`${activeStandardDetails !== null || view === "certificate" || view === "responses" ? "" : "lg:pl-64 pt-16"} min-h-screen transition-all duration-300`}
      >
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
        {activeStandardDetails === null && (
...
=======
        <div
          className={`w-full relative z-10 space-y-6 ${activeStandardDetails !== null ? "" : "p-4 md:p-6"}`}
        >
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
                    {selectedLang === "mr"
                      ? `मानक क्र. ${toMarathiNumerals(activeStandardDetails)}`
                      : `Standard No. ${activeStandardDetails}`}
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                  </h2>
...
=======
                        const isSelected =
                          selectedOptions[activeStandardDetails] === idx;
                        return (
                          <div
                            key={idx}
                            onClick={() =>
                              selectOption(activeStandardDetails, idx)
                            }
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
                      ...
                      <p className="text-[11px] font-bold text-orange-50 mt-0.5">
                        {t.infoSubtitle}
                      </p>
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                    </div>
...
=======
                        ...
                        <p className="text-slate-400 text-[10px] font-semibold">
                          {selectedLang === "mr"
                            ? "ही माहिती SQAAF अहवालात वापरली जाईल"
                            : "This information will be used in the SQAAF report"}
                        </p>
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                      </div>
                    </div>
...
=======
                      ...
                      <p className="text-[10px] font-black uppercase tracking-widest text-orange-50">
                        {t.subtitle}
                      </p>
                    </div>
                  </div>
...
=======
                        <span className="text-[10px] md:text-xs font-black text-slate-500 tracking-widest block mb-1">
                          Teacher In-Charge
                        </span>
                        <p>
                          {infoHeadmaster ||
                            profile?.fullName ||
                            "BALASAHEB RAMKISHAN KENDRE"}
                        </p>
                      </div>
                      <div>
                        <span className="text-[10px] md:text-xs font-black text-slate-500 tracking-widest block mb-1">
...
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                        ...
                        <button
<<<<<<< HEAD
                          onClick={() => handleDownloadPdf("table", "download")}
                          className="py-3 px-4 bg-[#1e1b4b] text-white rounded-3xl text-[13px] font-bold hover:bg-slate-800 transition-all flex items-center justify-center gap-1.5 cursor-pointer active:scale-95"
                        >
...
=======
                        ...
                        >
                          <Download className="size-4" />
                          <span>
                            {selectedLang === "mr" ? "डाऊनलोड करा" : "Download"}
                          </span>
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                        </button>
                      </div>
...
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                        ...
                        <button
<<<<<<< HEAD
                          onClick={() => handleDownloadPdf("responses", "download")}
                          className="py-3 px-4 bg-[#1e1b4b] text-white rounded-3xl text-[13px] font-bold hover:bg-slate-800 transition-all flex items-center justify-center gap-1.5 cursor-pointer active:scale-95"
                        >
                          <Download className="size-4" />
                          <span>{selectedLang === "mr" ? "डाऊनलोड करा" : "Download"}</span>
...
=======
                          <span>
                            {selectedLang === "mr" ? "जतन करा" : "Save Changes"}
                          </span>
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                        </>
                      ) : (
...
=======
                      {selectedLang === "mr"
                        ? "मूल्यांकन तक्ता अहवाल"
                        : "Assessment Table Report"}
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                    </h2>
                  </div>
...
=======
                          <th className="px-3 py-4 text-center font-black border-r border-slate-700 w-[50px]">
                            {selectedLang === "mr" ? "अ.क्र." : "Sr."}
                          </th>
                          <th className="px-3 py-4 text-left font-black border-r border-slate-700 w-[200px]">
                            {selectedLang === "mr" ? "मानक" : "Standard"}
                          </th>
                          <th className="px-3 py-4 text-left font-black border-r border-slate-700 bg-red-950/20 text-red-900">
                            {selectedLang === "mr" ? "स्तर १" : "Level 1"}
                          </th>
                          <th className="px-3 py-4 text-left font-black border-r border-slate-700 bg-orange-950/20 text-orange-900">
                            {selectedLang === "mr" ? "स्तर २" : "Level 2"}
                          </th>
                          <th className="px-3 py-4 text-left font-black border-r border-slate-700 bg-yellow-950/20 text-yellow-900">
                            {selectedLang === "mr" ? "स्तर ३" : "Level 3"}
                          </th>
                          <th className="px-3 py-4 text-left font-black border-r border-slate-700 bg-green-950/20 text-green-900">
                            {selectedLang === "mr" ? "स्तर ४" : "Level 4"}
                          </th>
                          <th className="px-3 py-4 text-center font-black border-r border-slate-700 bg-purple-950/20 text-purple-900 w-[80px]">
                            {selectedLang === "mr"
                              ? "स्वमूल्यांकन"
                              : "Self Eval"}
                          </th>
                          <th className="px-3 py-4 text-center bg-indigo-950/20 text-indigo-900 w-[80px]">
                            {selectedLang === "mr"
                              ? "बाह्यमूल्यांकन"
                              : "Ext Eval"}
                          </th>
...
=======
                          ...
                          const extIdx = externalOptions[num];
                          const hasExt =
                            extIdx !== undefined && extIdx !== null;
                          const isExtNotApplicable = extIdx === 4;

                          return (
                            <tr
                              key={num}
                              className={`hover:bg-slate-50 transition-all ${isNotApplicable ? "opacity-70" : ""}`}
                            >
                              {/* Sr. */}
                              <td className="px-3 py-4 text-center font-black border-r border-slate-100 text-slate-800">
                                {selectedLang === "mr"
                                  ? toMarathiNumerals(num)
                                  : num}
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                              </td>
...
=======
                              <td
                                className={`px-2 py-4 text-center border-r border-slate-100 ${isSelected ? (isNotApplicable ? "bg-slate-100 text-slate-500" : "bg-amber-50 font-black text-amber-800") : "text-slate-400"}`}
                              >
                                {isEditingTable ? (
                                  <select
                                    value={
...
=======
                                        ...
                                        setCompletedStandards(updatedCompleted);
                                        localStorage.setItem(
                                          "sqaf_completed_standards",
                                          JSON.stringify(
                                            Array.from(updatedCompleted),
                                          ),
                                        );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                                      } else {
...
=======
                              <td
                                className={`px-2 py-4 text-center ${hasExt ? (isExtNotApplicable ? "bg-slate-100 text-slate-500" : "bg-indigo-50 font-black text-indigo-800") : "text-slate-400"}`}
                              >
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                                {isEditingTable ? (
                                  <select
...
=======
                      <span>
                        {selectedLang === "mr" ? "डाऊनलोड करा" : "Download PDF"}
                      </span>
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                    </button>
                  </div>
...
=======
                      const answeredEntries = Array.from(
                        { length: 128 },
                        (_, i) => {
                          const num = i + 1;
                          const idx =
...
=======
                          <span>
                            {certLang === "mr" ? "जतन करा" : "Save Changes"}
                          </span>
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                        </>
                      ) : (
...
=======
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "radial-gradient(circle, #fdfbf7 0%, #fff 100%)",
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                    }}
                  >
...
=======
                    <svg
                      className="absolute top-7 left-7 w-12 h-12 pointer-events-none text-[#bf953f]"
                      viewBox="0 0 48 48"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2.5"
...
=======
                    <svg
                      className="absolute top-7 right-7 w-12 h-12 pointer-events-none text-[#bf953f]"
                      viewBox="0 0 48 48"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2.5"
...
=======
                    <svg
                      className="absolute bottom-7 left-7 w-12 h-12 pointer-events-none text-[#bf953f]"
                      viewBox="0 0 48 48"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2.5"
...
=======
                    <svg
                      className="absolute bottom-7 right-7 w-12 h-12 pointer-events-none text-[#bf953f]"
                      viewBox="0 0 48 48"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2.5"
...
=======
                      <path
                        d="M 200,0 L 200,150 C 180,120 150,80 120,60 C 90,40 50,20 0,0 Z"
                        fill="url(#gold-grad)"
                        opacity="0.15"
                      />
                      <path
                        d="M 200,0 L 200,120 C 170,100 145,60 115,45 C 85,30 55,15 15,0 Z"
                        fill="url(#gold-grad)"
                        opacity="0.3"
                      />
                      <path
                        d="M 200,0 L 200,90 C 185,75 160,50 130,35 C 100,20 70,10 30,0 Z"
                        fill="url(#gold-grad)"
                        opacity="0.5"
                      />
                      <path
                        d="M 200,0 L 200,60 C 190,50 170,30 145,20 C 120,10 90,5 50,0 Z"
                        fill="url(#gold-grad)"
                        opacity="0.8"
                      />
                    </svg>
                    ...
                    >
                      <path
                        d="M 0,200 L 0,50 C 20,80 50,120 80,140 C 110,160 150,180 200,200 Z"
                        fill="url(#gold-grad)"
                        opacity="0.15"
                      />
                      <path
                        d="M 0,200 L 0,80 C 30,100 55,140 85,155 C 115,170 145,185 185,200 Z"
                        fill="url(#gold-grad)"
                        opacity="0.3"
                      />
                      <path
                        d="M 0,200 L 0,110 C 15,125 40,150 70,165 C 100,180 130,190 170,200 Z"
                        fill="url(#gold-grad)"
                        opacity="0.5"
                      />
                      <path
                        d="M 0,200 L 0,140 C 10,150 30,170 55,180 C 80,190 110,195 150,200 Z"
                        fill="url(#gold-grad)"
                        opacity="0.8"
                      />
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              certLang === "mr"
                                ? setCertTitleMr(e.target.value)
                                : setCertTitleEn(e.target.value)
                            }
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              certLang === "mr"
                                ? setCertDescMr(e.target.value)
                                : setCertDescEn(e.target.value)
                            }
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                            rows={3}
...
=======
                              ...
                              (एस.सी.ई.आर.टी.)
                              <br />
                              ७०८, सदाशिव पेठ, कुमठेकर मार्ग, पुणे – ४११0३0
                              <br />
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                              महाराष्ट्र, भारत
                            </>
...
=======
                              ...
                              (SCERT)
                              <br />
                              708, Sadashiv Peth, Kumthekar Marg, Pune – 411030
                              <br />
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                              Maharashtra, India
                            </>
...
=======
                      <span>
                        {selectedLang === "mr" ? "डेटा साफ करा" : "Reset Data"}
                      </span>
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                    </button>
...
=======
                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-orange-100">
                          Audit Status
                        </span>
...
=======
                          ...
                          <span className="bg-white/20 backdrop-blur-md text-white px-4 py-1.5 rounded-xl text-xs font-black min-w-[60px] text-center shadow-inner border border-white/30">
                            {totalStandards}
                          </span>
                        </div>
                        <div className="flex justify-between items-center py-3 border-b border-white/10">
                        ...
                        <div className="flex justify-between items-center py-3 border-b border-white/10">
                          <span className="text-orange-55 font-medium">
                            {t.uncompletedStands}
                          </span>
                          <span className="bg-white/20 backdrop-blur-md text-white px-4 py-1.5 rounded-xl text-xs font-black min-w-[60px] text-center shadow-inner border border-white/30">
                            {uncompletedCount}
                        ...
                        <div className="flex justify-between items-center py-3">
                          ...
                          <span className="bg-amber-300 text-slate-900 px-5 py-1.5 rounded-xl text-xs font-black min-w-[90px] text-center shadow-md">
...
=======
                        ...
                        <span className="bg-teal-500 text-white font-black text-xs px-3.5 py-1 rounded-full shadow-md shadow-teal-500/20">
                          {standards.length}
                        </span>
                      </div>
...
<<<<<<< HEAD
                                  localStorage.setItem("sqaaf_saved_scroll_position", scrollPos.toString());
                                }
                                const winScrollPos = window.scrollY;
                                setSavedWindowScrollPosition(winScrollPos);
                                localStorage.setItem("sqaaf_saved_window_scroll_position", winScrollPos.toString());

                                setLastSelectedStandard(num);
                                localStorage.setItem("sqaaf_last_selected_standard", num.toString());
=======
                                  localStorage.setItem(
                                    "sqaaf_saved_scroll_position",
                                    scrollPos.toString(),
                                  );
                                }
                                const winScrollPos = window.scrollY;
                                ...
                                localStorage.setItem(
                                  "sqaaf_saved_window_scroll_position",
                                  winScrollPos.toString(),
                                );

                                setLastSelectedStandard(num);
                                localStorage.setItem(
                                  "sqaaf_last_selected_standard",
                                  num.toString(),
                                );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
