...
=======
  const [fallbackFilePreview, setFallbackFilePreview] = useState<string | null>(
    null,
  );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
    const saved = localStorage.getItem(
      `sqaf_evidence_options_config_${standardId}`,
    );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
    let opts: string[] = [];
    if (saved) {
...
=======
        const checkedSaved = localStorage.getItem(
          `sqaf_evidence_checked_${standardId}_${idx}`,
        );
        states[idx] = checkedSaved === "true";

        const fileNameSaved = localStorage.getItem(
          `sqaf_evidence_file_name_${standardId}_${idx}`,
        );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
        if (fileNameSaved) {
...
=======
        const previewSaved = localStorage.getItem(
          `sqaf_evidence_file_preview_${standardId}_${idx}`,
        );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
        if (previewSaved) {
...
=======
        const typeSaved = localStorage.getItem(
          `sqaf_evidence_file_type_${standardId}_${idx}`,
        );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
        if (typeSaved) {
          types[idx] = typeSaved;
...
=======
        const savedPreview = localStorage.getItem(
          `sqaf_evidence_preview_${standardId}`,
        );
        if (savedPreview) {
          setFallbackFilePreview(savedPreview);
        }
        const savedType =
          localStorage.getItem(`sqaf_evidence_type_${standardId}`) ||
          "image/png";
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
          console.warn(
            "Could not save image preview to localStorage due to quota.",
          );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
        }
      };
...
=======
                  ...
                  <div className="flex-1 min-w-0">
                    <p
                      className={`font-extrabold text-sm md:text-[15px] leading-relaxed transition-colors ${
                        isChecked
        ...
        {fallbackFileName ? (
          ...
          >
            ...
            <div className="text-center">
              <p className="text-pink-900 font-black text-sm tracking-wide">
                {lang === "mr"
                  ? "फाईल निवडा किंवा येथे ड्रॅग करा"
                  : "Select file or drag here"}
              </p>
              <p className="text-pink-700/70 text-xs font-bold mt-1">
                {lang === "mr"
                  ? "प्रतिма फाईल (PNG, JPG) किंवा PDF फाईल"
                  : "Image files (PNG, JPG) or PDF file"}
              </p>
            </div>
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
          </div>
...
=======
const standardsDetailData: Record<
  number,
  {
    mr: {
      orangeDesc: string;
...
=======
  const [view, setView] = useState<
    "info" | "dashboard" | "summary" | "certificate"
  >("info");
  const [selectedLang, setSelectedLang] = useState<"mr" | "en">("mr");
  const [pdfLang, setPdfLang] = useState<"mr" | "en">("mr");
...
=======
      return (
        localStorage.getItem("sqaf_cert_school_name") ||
        infoSchoolName ||
        profile?.schoolName ||
...
=======
      return (
        localStorage.getItem("sqaf_cert_udise") ||
        infoUdise ||
        profile?.udise ||
        "27350800701"
      );
...
=======
      return (
        localStorage.getItem("sqaf_cert_title_en") ||
...
=======
      return (
        localStorage.getItem("sqaf_cert_title_mr") ||
...
=======
      return (
        localStorage.getItem("sqaf_cert_desc_en") ||
...
=======
      return (
        localStorage.getItem("sqaf_cert_desc_mr") ||
...
=======
      const toastId = toast.loading(
        selectedLang === "mr" ? "PDF तयार करत आहे..." : "Generating PDF...",
      );

      // Dynamically import pdf-lib
      const { PDFDocument, rgb, StandardFonts } = await import("pdf-lib");

      const pdfBytes = await fetch("/SQAAF_Self_Evaluation.pdf").then((res) =>
        res.arrayBuffer(),
      );
      const coordsRes = await fetch("/sqaaf_coords.json");
      const coordsMap = await coordsRes.json();
...
=======
      const NEW_L2_END = NEW_L2_START + 125.3 * SCALE;
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
      ...
      const pdfBytesModified = await pdfDoc.save();
      const blob = new Blob([pdfBytesModified as unknown as BlobPart], {
...
=======
  const obtainedMarks = Math.round(
    (completedCount / totalStandards) * totalMarks,
  );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
      <div
        className={
          activeStandardDetails !== null || view === "certificate"
            ? "hidden"
            : "block"
        }
      >
      ...
      <main
        className={`${activeStandardDetails !== null || view === "certificate" ? "" : "lg:pl-64 pt-16"} min-h-screen transition-all duration-300`}
      >
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
        {activeStandardDetails === null && (
...
=======
                                ...
                                setSavedWindowScrollPosition(winScrollPos);
                                localStorage.setItem(
                                  "sqaf_saved_window_scroll_position",
                                  winScrollPos.toString(),
                                );

                                setLastSelectedStandard(num);
                                localStorage.setItem(
                                  "sqaf_last_selected_standard",
                                  num.toString(),
                                );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
