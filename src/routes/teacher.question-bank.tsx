        ...
        <div className="p-4 md:p-8 space-y-6 max-w-full mx-auto">
          ...
          <div className="flex items-center gap-2 border-b-2 border-slate-200 pb-0 mb-2">
            <button
              ...
              className={`px-5 py-2.5 text-sm font-bold rounded-t-lg transition-all border-b-2 -mb-[2px] ${
                activeTab === "existing"
            ...
            <button
              ...
              className={`px-5 py-2.5 text-sm font-bold rounded-t-lg transition-all border-b-2 -mb-[2px] flex items-center gap-1.5 ${
