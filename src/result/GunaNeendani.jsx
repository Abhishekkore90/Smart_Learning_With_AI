    ...
    if (!academicYear || !classValue) {
      setAlertMessage(
        language === "English"
          ...
          : "कृपया प्रथम शैक्षणिक वर्ष आणि वर्ग निवडा!",
      );
      return;
    }
    setShowInput(true);
...
=======
        console.warn(
          "No subjects found for the specified class and academic year",
        );
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
        setSubjects({});
      }
...
=======
            ? parseInt(
                existingSubjectsArray[existingSubjectsArray.length - 1][0],
              ) + 1
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
            : 1;
...
=======
            setSpecialEntries((prev) => ({
              ...prev,
              [student.srNo]: data.specialEntries || "",
            }));
            setInterestsAndHobbies((prev) => ({
              ...prev,
              [student.srNo]: data.interestsAndHobbies || "",
            }));
            setNecessaryCorrections((prev) => ({
              ...prev,
              [student.srNo]: data.necessaryCorrections || "",
            }));
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
          } else {
...
=======
  ...
  const handleDelete = () => {
    if (
      subject &&
      window.confirm(
        "Are you sure you want to delete this subject? This will delete selected subject data ",
      )
    ) {
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
        <div className=" main-content-of-page">
          ...
          >
            {" "}
            {language === "English" ? "Marks Entry" : "गुण नोंदणी"}
          </h2>
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            >
              <tbody>
                <tr>
                  <th style={{ backgroundColor: "#b5d3f2" }}>
                    {language === "English"
                      ? "Academic Year "
                      : "शैक्षणिक वर्ष"}
                  </th>
...
=======
            ...
            >
              <Modal.Header closeButton>
                <Modal.Title>
                  {language === "English" ? "Add Subject" : "विषय जोडा"}
                </Modal.Title>
              </Modal.Header>
              <Modal.Body>
                <h2
                ...
                >
                  {language === "English" ? "Subjects" : "विषय"}
                </h2>
                <table
              ...
              <Modal.Footer>
                <Button
                  variant="secondary"
                  onClick={() => setShowDefaultSubjects(false)}
                >
                  {language === "English" ? " Close" : "Close करा"}
                </Button>
              </Modal.Footer>
          ...
          <div class="footer-notes">
            <div class="column">
              ...
              <ul>
                <li>
                  {language === "English"
                    ? "  First and Second Class - Dimensional + Compiled = Total Marks - 70+30=100 "
                    : "पहिली व दुसरी - आकारिक + संकलित = एकूण गुण - 70+30=100"}
                </li>
                <li>
                  {language === "English"
                    ? "  Third and Fourth Class - Dimensional + Compiled = Total Marks = 60 +40 100"
                    : "तिसरी व चौथी वर्ग - आकारिक + संकलित = एकूण गुण = 60 +40 100"}
                </li>
                <li>
                  {language === "English"
                    ? "  Fifth & Sixth Class - Dimensional + Compiled = Total Marks = 50+50=100"
                    : "पाचवी व सहावी वर्ग - आकारिक + संकलित = एकूण गुण = 50+50 = 100"}
                </li>
                <li>
                  {language === "English"
                    ? "  Seventh and Eighth Class- Dimensional + Compiled = Total marks = 40+60=;100"
                    : "सातवी व आठवी वर्ग- आकारिक + संकलित = एकूण गुण=40+60=100"}
                </li>
              </ul>
            </div>
            <div class="column">
              <h5>
                {language === "English"
                  ...
                  : "मार्क नोंदणी कशी करावी"}
              </h5>
              <p class="separate-note">
                {language === "English"
                  ? "  To register marks first select the type of examination then click on 'Enter Marks'. Then fill out special entries."
                  : "मार्क नोंदणी करण्यासाठी प्रथम शैक्षणिक वर्ष निवडा,नंतर वर्ग निवडा, आणि विषय हे 'Add Subject' वर क्लिक करुन विषय भरून घ्या. त्यानंतर परीक्षा सत्र निवडुन गुण प्रविष्ट करा."}
              </p>
            </div>
            <div class="column">
              <h5>
                {language === "English"
                  ? "Assessment:"
                  : "कला,कार्यानुभव आणि शा.शिक्षण विषय भारांश"}
              </h5>
              <p class="separate-note">
                {language === "English"
                  ? "For Arts, Work Experience and Physical Education subjects, out of 100 marks should be given for the assessment. There are no cumulative assessment points for these subjects."
                  : "कला, कार्यानुभव आणि शारीरिक शिक्षण विषयांसाठी पहिली ते आठवी या वर्गासाठी संकलित मूल्यमापनचेच 100 पैकी गुण द्यावेत.या विषयांसाठी आकारिक मूल्यमापन गुण नाहीत. "}
              </p>
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
            </div>
          </div>
...
=======
                ...
                >
                  ...
                  >
                    {language === "English" ? " Oral Work" : "तोंडी काम"}
                  </th>
                  <th
                    style={{
                      padding: "20px",
                  ...
                  >
                    {language === "English" ? " Activity" : "उपक्रम/कृती"}
                  </th>
                  <th
                    style={{
                      padding: "20px",
                  ...
                  >
                    {language === "English" ? " Project" : "प्रकल्प"}
                  </th>
                  <th
                    style={{
                      padding: "20px",
                  ...
                  >
                    {language === "English" ? " Homework" : "गृहपाठ"}
                  </th>
                  <th
                    style={{
                      padding: "20px",
...
=======
                          value={
                            marksData[student.srNo]?.Akarik?.["Test"] || ""
                          }
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
                          onChange={(e) =>
                            handleMarksChange(
...
=======
                          value={
                            marksData[student.srNo]?.Akarik?.["Total"] || ""
                          }
                          readOnly
                          className="form-control"
                          style={{ padding: "2px", textAlign: "center" }} // Adjust padding here
...
=======
                          value={
                            marksData[student.srNo]?.Sanklik?.[
                              "Demonstration"
                            ] || ""
                          }
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
                        ...
                        <datalist id="special Entries">
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Recognize the letters in Marathi "
                          ...
                          <option value={language === "English" ? " " : " "} />
                          <option
                            value={language === "English" ? "Marathi" : "मराठी"}
                          />

                          <option
                            value={
                              language === "English"
                                ? "Transcribes accurately in marathi. "
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Presents the difficulties problems to the teacher "
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Extra reading, paraphrasing in marathi "
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Expresses thoughts, experiences, feelings in clear words in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Draws conclusions about what is heard, read in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Says the content of the text heard in his/her own words in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "The poem says in the move in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Writes essays on given topics in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Speaks to the point on given topics in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Performs revelation, mute reading within the given time"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Uses standard language in daily practice"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Acts according to situation and person"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Dramatic dialogue is personified and personified in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Essay writing presents ideas in your own language in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Follows rules, instructions, discipline"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Communicates effectively in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Answers the questions correctly in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Pronounces words clearly while speaking in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Knows the difference between colloquial and standard language"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Listens intently to speech, conversation, communication, discussion"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Notices the beauty of language"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Reads the text with understanding in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Reads the text and answers the questions correctly in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Reads at appropriate pace and progression in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Reads with attention, concentration and comprehension"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Follows the rules of writing in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Uses proverbs and sayings in practice, giving meaning in sentences in marathi"
                                : "वाक्यप्रचार व म्हणीचा व्यवहारात, अर्थ सांगून वाक्यात उपयोग करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Understands new words in different dialects"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Participates in discussions on various topics"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Uses grammatically correct language in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Uses phrases, proverbs, slogans etc. in writing in marathi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Asks himself/herself questions"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "The handwriting is beautiful and meandering in marathi"
                          ...
                          <option value={language === "English" ? " " : " "} />
                          <option
                            value={language === "English" ? "Maths" : "गणित"}
                          />

                          <option
                            value={
                              language === "English"
                                ? "Uses various camouflage to solve the example"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Creates a distance by multiplication"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Solve the example by using the symbol correctly in the example"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Gives an accurate answer to an oral example"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Gets information about a great mathematician"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Draws graphs from the given information"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Uses mathematics in daily life and practice"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Converts to the right dimension when solving a dimension example"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Understands addition, subtraction, multiplication, division verbs"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Draws the perimeter of a geometric figure"
                                : "भौमितिक आकृत्याची परिमिती काढतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Draws the area of a geometric figure accurately"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Explains the properties of a geometric figure"
                                : "भौमितिक आकृत्याचे गुणधर्म सांगतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Recognizes small to large numbers"
                                : "लहान मोठ्या संख्या ओळखतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Specifies the surface and volume of different sizes"
                                : "विविध आकाराचे पृष्ठफळ व घनफळ सांगतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Understands different dimensions"
                                : "विविध परिमाणे समजून घेतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Draws various geometric structures proportionally"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Understands various geometric expressions"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Tells the units of different zodiac signs"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Explains the meaning and information of various terms accurately"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "The number is written in alphabetical order"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "The number writes in ascending and descending order"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Writes the number as an extension"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Recognizes the order of the numbers"
                                : "संख्याचा क्रम ओळखतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Tells and reads the type of number"
                                : "संख्याचे प्रकार सांगतो व वाचन करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Specifies the local value of the digit in the number"
                                : "संख्यातील  अंकाची स्थानिक किमत अचूक सांगतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Tells the value of the number on the number line"
                                : "संख्यारेषेवरील अंकाची किंमत सांगतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Performs basic operations on numbers"
                                : "संख्यावरील मूलभूत क्रिया बरोबर करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Solve simple literal examples based on equations"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Solve the example by filling in the values in the formula"
                          ...
                          <option
                            value={
                              language === "English" ? "English" : "इंग्रजी"
                            }
                          />
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Copies the Letters and words correctly in english"
                                : "अक्षरे आणि शब्द अचूकपणे कॉपी करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Enjoys the rhythm and understand in english"
                                : "लय एन्जॉय करतो आणि समजतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Gives responses in various contexts in english"
                                : "विविध संदर्भात प्रतिसाद देतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Identifies commonly used words in english"
                                : "सामान्यतः वापरलेले शब्द ओळखतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Listens with concentration in english"
                                : "एकाग्रतेने ऐकतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Reads aloud from textbook in english"
                                : "पाठ्यपुस्तकातून मोठ्याने वाचतो/ते."
                            }
                          />
                          <option
                            value={
                          ...
                          <option
                            value={
                              language === "English"
                                ...
                                : "समजून घेऊन शांतपणे वाचतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Reads the part in dialougs by understanding in english"
                                : "संवादातील भाग समजून घेऊन वाचतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Reads the poem in rhythm in english"
                                : "लयीत कविता वाचतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Rearranges the story events in english"
                                : "कथेतील घटनांची पुनर्रचना करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Recites with enjoyment poems and songs in english"
                                : "आनंद देणाऱ्या कविता आणि गाण्यांसह पाठ करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Solves the Activity by confidence in english"
                                : "आत्मविश्वासाने क्रियाकलाप सोडवतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Takes the dictation of familiar words in english"
                                : "परिचित शब्दांचे श्रुतलेखन घेतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Writes correctly on one line in english"
                                : "एका ओळीवर बरोबर लिहितो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Writes the answer of questions in english"
                                : "प्रश्नांची उत्तरे लिहितो/ते."
                            }
                          />
                          ...
                          <option
                            value={
                              language === "English" ? "Science" : "विज्ञान"
                            }
                          />
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Makes sustainable items from waste / it"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Notes causality in natural phenomena"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Tells the term of the substance"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Understands the meaning of technical terms"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Tells measures to prevent pollution"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Draws the exact figure of the experiment"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Detects diseases and describes symptoms"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Knows the remedies for the disease"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Provides information on different types of forces"
                          ...
                          <option value={language === "English" ? " " : " "} />
                          <option
                            value={language === "English" ? "Hindi" : "हिंदी"}
                          />

                          <option
                            value={
                              language === "English"
                                ? "Communicates with teachers in Hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Expresses his/her thoughts in Hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Memorizes songs and poems in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Says words after seeing thoughts in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Writes on his/her own inspiration on a given topic in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Uses Hindi language in daily life in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Writes an essay on a familiar topic in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Understands the meaning of the passage in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Reads text with understanding in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Reads extracurricular books and written materials in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Understands the difference between the sounds of mother tongue and Hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Conversates with friends in Hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Speaks fluently and intelligibly in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Listens to poetry with interest and pleasure in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Understands grammar clearly in writing in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Varnoka pronounces correctly in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Reads newspaper every day in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Understands general information in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Understands and repeats what he/she hears in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Writes clearly and accurately in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Pronounces clearly and correctly in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Pronounces vowels and consonants carefully in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Understands Hindi functional grammar clearly in hindi"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Views Hindi as the national language"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Is interested in Hindi language"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Translates Hindi words and sentences into mother tongue"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Uses modern tools"
                                : "आधुनिक साधनाचा वापर करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Creates innovation in activities and actions"
                                : "उपक्रमात व कृतीत नाविन्य निर्माण करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Understands the importance of work education"
                                : "कार्यशिक्षणाचे महत्व समजून घेतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Uses new techniques and technology while performing activities"
                                : "कृती करताना नवीन तंत्राचा व तंत्रज्ञानाचा वापर करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ...
                                : "चर्चेत सहभागी होतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Uses knowledge for livelihood"
                                : "ज्ञानाचा उपयोग उपजीवेकेसाठी करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Exhibits the finished product"
                                : "तयार केलेल्या वस्तूचे प्रदर्शन मांडतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Completes the given demonstration"
                                : "दिलेले प्रात्यक्षिक पूर्ण करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Collects relief during natural calamities"
                                : "नैसर्गिक आपत्तीच्या वेळी मदत गोळा करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ...
                                : "परिसर स्वच्छ ठेवतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Does project presentation well"
                                : "प्रकल्पाचे सादरीकरण चांगले करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Cultivates various values"
                                : "विविध मुल्याची जोपासना करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Takes teacher's co-operation Behaves in an understanding manner"
                                : "शिक्षकाचे सहकार्य घेतो  समजशील वर्तन करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Finds solutions to problem solving"
                                : "समस्या निराकरणासाठी उपाय शोधतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Strives for the development of society and nation"
                                : "समाजाच्या व राष्ट्राच्या विकासासाठी झटतो/ते."
                            }
                          />
                          ...
                          <option
                            value={
                              language === "English" ? "P.T." : "शारीरिक शिक्षण"
                            }
                          />
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Follows healthy habits"
                                : "आरोग्यदायी सवयींचे पालन करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Explains the importance of exercise for health"
                                : "आरोग्यासाठी व्यायामांचे महत्व सांगतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Behaves with others in a sportsmanlike manner"
                                : "इतरांशी खिलाडू वृत्तीने वागतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Plans the field keeping in mind the measurements of the playing field"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Acquires various sports skills"
                                : "खेळांची विविध कौशल्ये आत्मसात करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Cultivates patriotic values ​​through sports"
                                : "खेळातून राष्ट्रभक्ती मूल्यांची जोपासना करतो/ते."
                            }
                          />
                          <option
                            value={
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Guides group mates"
                                : "गटातील सहकर्‍यांना मार्गदर्शन करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Joyfully accepts victory and defeat"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Participates in daily school sports"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Respects the decisions of the umpires"
                                : "पंचांच्या निर्णयांचे आदर करतो/ते."
                            }
                          />
                          <option
                            value={
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Likes to do various tasks on the field"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Performs various types of yoga and exercises"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Gets information about various yogasanas and exercises"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Gets information about various national and international sports"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Does physical labor with pleasure"
                          ...
                          <option
                            value={
                              language === "English" ? "Samajik" : "सामाजिक"
                            }
                          />
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Tells about the historical place"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "The Constitution and the Pledge says"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Tells information about social reformer"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "It tells the AD year of historical events"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "States the fundamental rights of a citizen"
                                : "नागरिकाचे मूलभूत अधिकार सांगतो/ते."
                            }
                          />
>>>>>>> dbeff7e14a4166b051f7c9a6dda16ad16f4ca557
...
=======
                          onChange={(e) =>
                            handleInterestsAndHobbiesChange(
                              student.srNo,
                              e.target.value,
                            )
                          }
                        ...
                        <datalist id="Interests and hobbies">
                          ...
                          <option
                            value={
                              language === "English" ? "Swimming" : "पोहणे."
                            }
                          />
                          <option
                            value={
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Writes essays, stories, or poetry "
                                : " निबंध, कथा किंवा कविता लिहितो/ते."
                            }
                          />
                          <option
                            value={
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Likes cycling, cricket, running, swimming "
                                : " सायकलिंग, क्रिकेट, धावणे, पोहणे आवडते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ...
                                : "रेखाचित्र, चित्रकला आवडते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Likes to speaking and debate competitions "
                                : " भाषण आणि वादविवाद स्पर्धा करायला आवडते."
                            }
                          />
                          <option
                            value={
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Likes traveling, birdwatching"
                                : "प्रवास करणे, पक्षी निरीक्षण करणे आवडते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Writes stories, poems, articles, etc"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Reads newspapers, magazines etc"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Reads english daily newspaper"
                                : "इंग्रजी दैनिक वर्तमानपत्र वाचतो/ते."
                            }
                          />
                          <option
                            value={
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Crops, weather, land etc. Collects information about"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "dramatizes, participates in conversation"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Actions, activities are done with passion"
                                : "कृती,उपक्रम आवडीने करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Completes the project through his/her own participation"
                                : "प्रकल्प स्वत:च्या सहभागातून पूर्ण करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Seeks to acquire professional skills"
                                : "व्यावसायिक कौशल्ये प्राप्त करण्याचा प्रयत्न करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Acquires skill in using materials, tools"
                                : "साहित्य,साधने वापराबाबत कौशल्य प्राप्त करतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Exercises regularly for health"
                          ...
                          <option
                            value={
                              language === "English"
                                ...
                                : "खेळ व शारिरीक हालचालीतून आनंद मिळवतो/ते."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Participates spontaneously in sports"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Participates in various sports and competitions"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Get to know the best players"
                                : "श्रेष्ठ खेळाडूंची माहिती करून घेतो/ते."
                            }
                          />
                          <option
                            value={
...
=======
                          onChange={(e) =>
                            handleNecessaryCorrectionsChange(
                              student.srNo,
                              e.target.value,
                            )
                          }
                        ...
                        <datalist id="Necessary corrections">
                          <option
                            value={
                              language === "English"
                                ...
                                : "अधिक व्यवस्थित आणि सुवाच्यपणे लिहिण्याची गरज आहे"
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Revise the chapter, understand the concept "
                                : "संकल्पना अधिक चांगल्या प्रकारे समजून घेण्यासाठी धड्याची पुन्हा उजळणी करावी लागेल."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Write all steps clearly instead of final answer "
                                : " फक्त अंतिम उत्तराऐवजी सर्व चरण स्पष्टपणे लिहिण्याची गरज आहे."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Need to maintain silence, pay attention in class "
                                : " शांतता राखणे आणि वर्गात लक्ष देणे आवश्यक आहे."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ...
                                : " असाइनमेंट वेळेवर सबमिट करणे आवश्यक आहे."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Try to answer in more detail with examples "
                                : "उदाहरणांसह अधिक तपशीलवार उत्तर देण्याचा प्रयत्न केला पाहिजे."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ...
                                : " उत्तर देण्यापूर्वी प्रश्न काळजीपूर्वक वाचा."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ...
                                : "सारख्या-वेगळ्या गणिताच्या समस्यांचा नियमित सराव करा."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ...
                                : " स्पष्ट आणि प्रभावी संवादाचा सराव करणे आवश्यक आहे."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Focus on improving your reading by practicing "
                                : "वाचनाचा सराव करून आपले वाचन सुधारण्यावर भर देणे आवश्यक आहे."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ...
                                : "तुमचा गणवेश व्यवस्थित परिधान करणे आवश्यक आहे."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Check spelling, punctuation, and grammar mistakes"
                                : "शब्दलेखन, विरामचिन्हे आणि व्याकरणाच्या चुका तपासणे आवश्यक आहे.."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Revise weak subjects and practice more"
                                : "कमकुवत विषयांची उजळणी करा आणि अधिक सराव करा."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Neatly label diagrams and use proper margins in notebooks"
                                : "सुबकपणे आकृती लेबल करा आणि नोटबुकमध्ये योग्य मार्जिन वापरा."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ? "Maintain discipline and avoid unnecessary talking in class"
                                : "शिस्त पाळावी लागेल आणि वर्गात अनावश्यक बोलणे टाळावे लागेल."
                            }
                          />
                          <option
                            value={
                              language === "English"
                                ...
                                : "शिक्षक, वर्गमित्र आणि शाळेतील कर्मचारी यांचा आदर केला पाहिजे."
                            }
                          />
                          <option
                            value={
                          ...
                          <option
                            value={
                              language === "English"
                                ? "There should be active participation in the experiment"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Pay attention to mathematics subject"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "The handwriting should be improved"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Collect and translate English words"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "English reading and writing should be practiced"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "The letter needs to be corrected"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Reading and writing should be improved"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "Pay attention to daily attendance"
                          ...
                          <option
                            value={
                              language === "English"
                                ? "The arrangement in the math should be correct"
