...
const Failed = () => {
  ...
  const filteredExamNames = examNames.filter(
    (examName) => examName === "Second Semester",
  );
...
=======
  ...
  const calculateTotalAndPercentage = (results) => {
    ...
    setTotalMarks(newTotalMarks);
    const newPercentage =
      subjectsCount > 0 ? (newTotalMarks / (subjectsCount * 100)) * 100 : 0;
    setPercentage(newPercentage);
  };

  const totalSubjects = selectedStudentResults?.results
    ? Object.keys(selectedStudentResults.results).filter(
    ...
    <div>
      ...
      <div className=" main-content-of-page">
        <h3 style={{ color: "rgb(3, 54, 94)", textAlign: "center" }}>
          {" "}
          {language === "English" ? "Re-Exam" : "पुनर परिषा"}
        </h3>
        <table className="table table-striped table-bordered">
          <tbody>
            <tr>
              ...
              <thead>
                <tr>
                  <th className="custom-width">
                    {language === "English" ? "Register No " : "रजिस्टर नंबर"}
                  </th>
                  <th>
                    {language === "English"
                      ? "Student Name "
                          ...
                          {firstSemesterMonths.map((month, index) => (
                            <td key={index}>
                              <input
                                ...
                                onChange={(e) =>
                                  handleInputChange(type, month, e.target.value)
                                }
                              />
                            </td>
                          ))}
              ...
              <div className="container mt-1">
                <div className="left">
                    ...
                    <table className="table table-striped table-bordered">
                      <thead>
                        ...
                        <tr>
                          ...
                          <th>{language === "English" ? "Grade" : "गुण"}</th>
                          <th>
                            {language === "English" ? "Min. Mark" : "किमान गुण"}
                          </th>
                          <th>
                            {language === "English"
                              ? "Total Marks"
                      ...
                      <tbody>
                        ...
                        selectedStudentResults.results ? (
                          subjectSequence
                            ...
                            ) // Ensure subjects exist in the results
                            .map((subject) => {
                              const grades =
                                ...
                                <tr key={subject}>
                                  ...
                                  <td>
                                    <input
                                      ...
                                      value={grades.tempSankalikTotal || ""} // Temporary second semester marks
                                      onChange={(e) =>
                                        handleSankalikChange(e, subject)
                                      }
                                      className="form-control"
                                    />
                                  </td>
                  ...
                  <div>
                    <p>
                      {language === "English"
                        ? "School d after summer vacation. / / will start from"
