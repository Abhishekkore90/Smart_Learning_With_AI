  ...
  const loadUserFirestoreData = async () => {
    ...
    try {
      ...
      try {
        ...
        const docIdsSem1 = [
          ...currentTeacherId2 ? [
            `${currentTeacherId2}_${selectedClass}_${selectedMedium}_${academicYear}_sem1`,
            `${currentTeacherId2}_${selectedClass}_${academicYear}_sem1`
          ] : [],
        ...
        const docIdsSem2 = [
          ...currentTeacherId2 ? [
            `${currentTeacherId2}_${selectedClass}_${selectedMedium}_${academicYear}_sem2`,
            `${currentTeacherId2}_${selectedClass}_${academicYear}_sem2`
          ] : [],
        ...
        const docIdsGen = [
          ...currentTeacherId2 ? [
            `${currentTeacherId2}_${selectedClass}_${selectedMedium}_${academicYear}`,
            `${currentTeacherId2}_${selectedClass}_${academicYear}`
          ] : [],
