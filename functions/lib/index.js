  ...
  try {
    ...
    if (model === "chatgpt") {
      const apiKey =
        ...
        ((_a = functions.config().openai) === null || _a === void 0
          ? void 0
          : _a.key);
      if (!apiKey)
        throw new functions.https.HttpsError(
      ...
      return {
        text:
          ((_d =
            (_c =
              (_b = result.choices) === null || _b === void 0
                ? void 0
                : _b[0]) === null || _c === void 0
              ? void 0
              : _c.message) === null || _d === void 0
            ? void 0
            : _d.content) || "No response.",
      };
    }
    // -------------------------------------------------------------
    // CLAUDE (Anthropic)
    // -------------------------------------------------------------
      ...
      const apiKey =
        ...
        ((_e = functions.config().claude) === null || _e === void 0
          ? void 0
          : _e.key);
      if (!apiKey)
        throw new functions.https.HttpsError(
      ...
      if (!response.ok) {
        ...
        if (response.status === 403 || response.status === 400) {
          ...
          if (
            (_g =
              (_f =
                errBody === null || errBody === void 0
                  ? void 0
                  : errBody.error) === null || _f === void 0
                ? void 0
                : _f.message) === null || _g === void 0
              ? void 0
              : _g.includes("credit balance is too low")
          ) {
            throw new functions.https.HttpsError(
              "resource-exhausted",
      ...
      return {
        text:
          ((_j =
            (_h = result.content) === null || _h === void 0
              ? void 0
              : _h[0]) === null || _j === void 0
            ? void 0
            : _j.text) || "No response.",
    ...
    // -------------------------------------------------------------
      ...
      const apiKey =
        ...
        ((_k = functions.config().gemini) === null || _k === void 0
          ? void 0
          : _k.key);
      if (!apiKey)
        throw new functions.https.HttpsError(
        ...
        text:
          ((_q =
            (_p =
              (_o =
                (_m =
                  (_l = result.candidates) === null || _l === void 0
                    ? void 0
                    : _l[0]) === null || _m === void 0
                  ? void 0
                  : _m.content) === null || _o === void 0
                ? void 0
                : _o.parts) === null || _p === void 0
              ? void 0
              : _p[0]) === null || _q === void 0
            ? void 0
            : _q.text) || "No response.",
